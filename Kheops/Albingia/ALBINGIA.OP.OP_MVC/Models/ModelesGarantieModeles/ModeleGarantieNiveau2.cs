...
{
    [Serializable]
    public class ModeleGarantieNiveau2 : IModeleGarantieNiveau
    {
        ...
        public List<ModeleGarantieNiveau3> Modeles { get; set; }
        ...
        public ModeleGarantieNiveau2()
        {
            ...
            this.CodeParent = 0;
            this.CodeNiv1 = 0;
            this.Modeles = new List<ModeleGarantieNiveau3>();
