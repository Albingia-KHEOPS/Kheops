...
{
    [Serializable]
    public class ModeleGarantieNiveau3 : IModeleGarantieNiveau
    {
        ...
        public List<ModeleGarantieNiveau4> Modeles { get; set; }
        ...
        public bool isExcluding
        {
            get
            {
                if (AppliqueA && Caractere != "B" && Caractere != "O")
                    return true;
                else
                    return false;
            }
        ...
        public ModeleGarantieNiveau3()
        {
            ...
            this.CodeParent = 0;
            this.CodeNiv1 = 0;
            this.Modeles = new List<ModeleGarantieNiveau4>();
