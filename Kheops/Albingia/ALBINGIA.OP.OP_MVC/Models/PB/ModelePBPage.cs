...
{
    public class ModelePBPage : MetaModelsBase, IRegulModel
    {
        ...
        public List<ModeleExercicePB> ListeExercices { get; set; }

        public ModeleCreationRegule InfoPB { get; set; }
        ...
        public bool CanCreatePB { get; set; }
