CREATE PROCEDURE SP_FORMGARHISTOAVT ( 
	...
	DECLARE CURSORFORMULE CURSOR FOR 
		...
		SELECT CODEOPTION , GUIDV , CODEVOLET , DESCRVOLET , CARACVOLET , GUIDVOLET , VOLETCOLLAPSE , CHECKV , 
			...
			FLAGMODIFNIV1 , PARAMNATMODNIV1 , CODEGARINCOMPNIV1 , CODEGARASSOCNIV1 , CODEGARAALTNIV1 , INVENPOSSIBLE1 , TYPEINVEN1 , 
			CODEINVEN1 , DATDEB1 , DATFIN1 , HEUFIN1 , DUREE1 , DURUNI1 , ALIMNIV1 , 
			 
			GUIDNIV2 , CODENIV2 , CODEGARNIV2 , DESCRNIV2 , CARACNIV2 , NATURENIV2 , NATUREPARAMNIV2 , CODEPARENTNIV2 , CODENIV1NIV2 , 
			FLAGMODIFNIV2 , PARAMNATMODNIV2 , CODEGARINCOMPNIV2 , CODEGARASSOCNIV2 , CODEGARAALTNIV2 , INVENPOSSIBLE2 , TYPEINVEN2 , 
			CODEINVEN2 , DATDEB2 , DATFIN2 , HEUFIN2 , DUREE2 , DURUNI2 , 
			 
			GUIDNIV3 , CODENIV3 , CODEGARNIV3 , DESCRNIV3 , CARACNIV3 , NATURENIV3 , NATUREPARAMNIV3 , CODEPARENTNIV3 , CODENIV1NIV3 , 
			FLAGMODIFNIV3 , PARAMNATMODNIV3 , CODEGARINCOMPNIV3 , CODEGARASSOCNIV3 , CODEGARAALTNIV3 , INVENPOSSIBLE3 , TYPEINVEN3 , 
			CODEINVEN3 , DATDEB3 , DATFIN3 , HEUFIN3 , DUREE3 , DURUNI3 , 
			 
			GUIDNIV4 , CODENIV4 , CODEGARNIV4 , DESCRNIV4 , CARACNIV4 , NATURENIV4 , NATUREPARAMNIV4 , CODEPARENTNIV4 , CODENIV1NIV4 , 
			FLAGMODIFNIV4 , PARAMNATMODNIV4 , CODEGARINCOMPNIV4 , CODEGARASSOCNIV4 , CODEGARAALTNIV4 , INVENPOSSIBLE4 , TYPEINVEN4 , 
			CODEINVEN4 , DATDEB4 , DATFIN4 , HEUFIN4 , DUREE4 , DURUNI4 , 
			 
			APPLIQUEA 
		 
		FROM V_FORMGARHISTOAVT 
