...
CREATE PROCEDURE  SP_SETLISTRSQREGULE_BURNER ( 
	...
	LANGUAGE SQL 
	SPECIFIC SP_SETLISTRSQREGULE_BURNER 
	NOT DETERMINISTIC 
	MODIFIES SQL DATA 
	...
	P1 : BEGIN ATOMIC 
		...
		DECLARE V_KILRIA DECIMAL ( 3 , 0 ) DEFAULT 0 ; 
		...
		ELSE 
				...
				IF ( P_REGULNIV = 'E' ) THEN 
					...
					DO
						...
						SET KHWEXE = P_EXERCICE , KHWDEBP = P_PERIODEDEB , KHWFINP = P_PERIODEFIN , KHWICT = P_CODEICT , KHWICC = P_CODEICC , 
							...
							KHWPBT = PBT , KHWPBA = PBA , KHWPBS = PBS , KHWPBR = PBR , KHWPBP = PBP , KHWBRNT = BRNT, KHWBRNC = BRNC
						WHERE KHWID = V_RGID ;
			...
			VALUES 
			( P_TYPE , P_CODECONTRAT , P_VERSION , V_CODEAVN , P_TYPEREGULE , 'G' , V_DATENOWANNEE , V_DATENOWMOIS , V_DATENOWJOUR , V_HEURENOW , 
				'' , 'I' , 0 , 0 , 0 , 0 , 0 , 0 , P_USER , V_DATENOWANNEE , V_DATENOWMOIS , V_DATENOWJOUR , V_HEURENOW ) ; 
