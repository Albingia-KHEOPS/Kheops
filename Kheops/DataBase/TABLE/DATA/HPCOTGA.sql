CREATE TABLE ZALBINKHEO.HPCOTGA ( 
--  SQL150B   10   REUSEDLT(*NO) de la table HPCOTGA de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour HPCOTGA de ZALBINKHEO. 
	...
	KDNAVN NUMERIC(3, 0) NOT NULL DEFAULT 0 , 
	KDNHIN NUMERIC(3, 0) NOT NULL DEFAULT 0 , 
...
LABEL ON TABLE ZALBINKHEO.HPCOTGA 
	IS 'KHEOPS histo Cotisation Garan' ; 
  
LABEL ON COLUMN ZALBINKHEO.HPCOTGA 
( KDNID IS 'ID unique' , 
	KDNTYP IS 'Type O/P' , 
	KDNIPB IS 'IPB' , 
	KDNALX IS 'ALX' , 
	KDNAVN IS 'N° avenant' , 
	KDNHIN IS 'N° histo par avenant' , 
	KDNFOR IS 'Formule' , 
...
( KDNID TEXT IS 'ID unique' , 
	...
	KDNIPB TEXT IS 'IPB' , 
	KDNALX TEXT IS 'ALX' , 
	KDNAVN TEXT IS 'N° avenant' , 
	KDNHIN TEXT IS 'N° histo par avenant' , 
