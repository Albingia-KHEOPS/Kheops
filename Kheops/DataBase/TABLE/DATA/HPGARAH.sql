CREATE TABLE ZALBINKHEO.HPGARAH ( 
--  SQL150B   10   REUSEDLT(*NO) de la table HPGARAH de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour HPGARAH de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.HPGARAH 
	IS 'Histo  Garanties GARAN histo' ; 
  
LABEL ON COLUMN ZALBINKHEO.HPGARAH 
( KDEID IS 'ID unique' , 
	KDETYP IS 'Type O/P' , 
	KDEIPB IS 'IPB' , 
	KDEALX IS 'ALX' , 
	...
	KDEPNTM IS 'Parame Nature modif' , 
...
( KDEID TEXT IS 'ID unique' , 
	...
	KDEPNTM TEXT IS 'Paramétrage Nature modifibale' , 
	KDEALA TEXT IS 'Type Alimentation' , 
	KDEPALA TEXT IS 'Paramétrage Type Alimentation' , 
	KDEALO TEXT IS 'Alimentation Origine '' '' / Auto' ) ; 
