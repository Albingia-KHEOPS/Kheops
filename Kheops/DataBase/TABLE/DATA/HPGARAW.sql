CREATE TABLE ZALBINKHEO.HPGARAW ( 
--  SQL150B   10   REUSEDLT(*NO) de la table HPGARAW de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour HPGARAW de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.HPGARAW 
	IS 'KHEOPS histo Garanties W' ; 
  
LABEL ON COLUMN ZALBINKHEO.HPGARAW 
( KDEID IS 'ID unique' , 
	KDETYP IS 'Type O/P' , 
	KDEIPB IS 'IPB' , 
	KDEALX IS 'ALX' , 
...
( KDEID TEXT IS 'ID unique' , 
	...
	KDEALO TEXT IS 'Alimentat°Origine '' '' / Auto' ) ; 
