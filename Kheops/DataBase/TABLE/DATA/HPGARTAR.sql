CREATE TABLE ZALBINKHEO.HPGARTAR ( 
--  SQL150B   10   REUSEDLT(*NO) de la table HPGARTAR de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour HPGARTAR de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.HPGARTAR 
	IS 'KHEOPS histo Tarif' ; 
  
LABEL ON COLUMN ZALBINKHEO.HPGARTAR 
( KDGID IS 'ID unique' , 
	KDGTYP IS 'Type O/P' , 
	KDGIPB IS 'IPB' , 
	KDGALX IS 'ALX' , 
