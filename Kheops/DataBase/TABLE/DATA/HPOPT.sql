CREATE TABLE ZALBINKHEO.HPOPT ( 
--  SQL150B   10   REUSEDLT(*NO) de la table HPOPT de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour HPOPT de ZALBINKHEO. 
	...
	KDBAVN NUMERIC(3, 0) NOT NULL DEFAULT 0 , 
	KDBHIN NUMERIC(3, 0) NOT NULL DEFAULT 0 , 
...
LABEL ON TABLE ZALBINKHEO.HPOPT 
	IS 'KHEOPS Histo  O/P Option   KDB' ; 
  
LABEL ON COLUMN ZALBINKHEO.HPOPT 
( KDBID IS 'ID unique' , 
	KDBTYP IS 'Type O/P' , 
	KDBIPB IS 'IPB/ALX' , 
	KDBALX IS 'Aliment/Version' , 
	KDBAVN IS 'N° avenant' , 
	KDBHIN IS 'N° histo par avenant' , 
	KDBFOR IS 'Formule' , 
...
( KDBID TEXT IS 'ID unique' , 
	...
	KDBAVN TEXT IS 'N° avenant' , 
	KDBHIN TEXT IS 'N° histo par avenant' , 
	...
	KDBTMC TEXT IS 'Total : Montant Calculé Référence' , 
	KDBTFF TEXT IS 'Total : Montant Forcé Référence' , 
	KDBTFP TEXT IS 'Total : Coefficient de calcul' , 
	KDBPRO TEXT IS 'Total : Montant Provisionnel O/N' , 
	KDBTMI TEXT IS 'Total : Mnt forcé pour Minimum O/N' , 
	KDBTFM TEXT IS 'Total : Motif forcé' , 
