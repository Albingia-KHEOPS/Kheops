CREATE TABLE ZALBINKHEO.HPOPTAP ( 
--  SQL150B   10   REUSEDLT(*NO) de la table HPOPTAP de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour HPOPTAP de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.HPOPTAP 
	IS 'Histo  Option s''applique à KDD' ; 
  
LABEL ON COLUMN ZALBINKHEO.HPOPTAP 
( KDDID IS 'ID unique' , 
	KDDTYP IS 'Type O/P' , 
	KDDIPB IS 'IPB' , 
	KDDALX IS 'ALX' , 
