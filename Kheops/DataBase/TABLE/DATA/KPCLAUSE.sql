CREATE TABLE ZALBINKHEO.KPCLAUSE ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPCLAUSE de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPCLAUSE de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPCLAUSE 
	IS 'KHEOPS O/P  Clauses' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPCLAUSE 
( KCAID IS 'ID unique' , 
	KCATYP IS 'TYP O/P' , 
	KCAIPB IS 'IPB' , 
	KCAALX IS 'ALX' , 
	...
	KCAVER IS 'N° version' , 
	KCATXL IS 'Lien cl libre ou doc' , 
	...
	KCAELGI IS 'Elém Gen  ID' , 
	KCAXTL IS 'Texte libre O/N' , 
	KCATYPD IS 'Doc Ajouté/Génée/Ext' , 
...
( KCAID TEXT IS 'ID unique' , 
	...
	KCATXL TEXT IS 'Doc libre lien KPDOC ou KPDOCEXT' , 
