CREATE TABLE ZALBINKHEO.KPDOC ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPDOC de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPDOC de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPDOC 
	IS 'Documents  (Produ Indemn ..)                   KEQ' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPDOC 
( KEQID IS 'ID unique' , 
	KEQTYP IS 'Type O/P' , 
	KEQIPB IS 'IPB' , 
	KEQALX IS 'ALX' , 
