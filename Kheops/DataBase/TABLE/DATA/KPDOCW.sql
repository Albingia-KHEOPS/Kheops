CREATE TABLE ZALBINKHEO.KPDOCW ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPDOCW de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPDOCW de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPDOCW 
	IS 'Documents _W                                   KEQ' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPDOCW 
( KEQID IS 'ID unique' , 
	KEQTYP IS 'Type O/P' , 
	KEQIPB IS 'IPB' , 
	KEQALX IS 'ALX' , 
...
( KEQID TEXT IS 'ID unique' , 
	...
	KEQTGL TEXT IS 'Type de Génération Figé ou Libre' , 
