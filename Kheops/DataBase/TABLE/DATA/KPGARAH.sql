CREATE TABLE ZALBINKHEO.KPGARAH ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPGARAH de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPGARAH de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPGARAH 
	IS 'KHEOPS Garanties GARAN histo' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPGARAH 
( KDEID IS 'ID unique' , 
	KDETYP IS 'Type O/P' , 
	KDEIPB IS 'IPB' , 
	KDEALX IS 'ALX' , 
...
( KDEID TEXT IS 'ID unique' , 
	...
	KDEALO TEXT IS 'Alimentation Origine '' '' ou Auto' ) ; 
