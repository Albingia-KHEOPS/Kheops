CREATE TABLE ZALBINKHEO.KPGARAN ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPGARAN de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPGARAN de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPGARAN 
	IS 'KHEOPS Garanties' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPGARAN 
( KDEID IS 'ID unique' , 
	KDETYP IS 'Type O/P' , 
	KDEIPB IS 'IPB' , 
	KDEALX IS 'ALX' , 
