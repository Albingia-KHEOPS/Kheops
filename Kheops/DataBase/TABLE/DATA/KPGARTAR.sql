CREATE TABLE ZALBINKHEO.KPGARTAR ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPGARTAR de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPGARTAR de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPGARTAR 
	IS 'KHEOPS Tarif' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPGARTAR 
( KDGID IS 'ID unique' , 
	KDGTYP IS 'Type O/P' , 
	KDGIPB IS 'IPB' , 
	KDGALX IS 'ALX' , 
