CREATE TABLE ZALBINKHEO.KPIOPT ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPIOPT de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPIOPT de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPIOPT 
	IS 'KHEOPS Inf Spé  Option                         KFC' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPIOPT 
( KFCID IS 'ID unique' , 
	KFCTYP IS 'Type O/P' , 
	KFCIPB IS 'IPB/ALX' , 
