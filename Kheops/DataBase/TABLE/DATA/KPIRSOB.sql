CREATE TABLE ZALBINKHEO.KPIRSOB ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPIRSOB de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPIRSOB de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPIRSOB 
	IS 'KHEOPS InfoSpé Objet                           KFA' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPIRSOB 
( KFATYP IS 'Type O/P' , 
	KFAIPB IS 'IPB' , 
	KFAALX IS 'ALX' , 
	KFAAVN IS 'Avt' , 
...
( KFATYP TEXT IS 'Type O/P' , 
	KFAIPB TEXT IS 'IPB' , 
	KFAALX TEXT IS 'ALX' , 
	KFAAVN TEXT IS 'N° Avenant           NE PAS UTILISER' , 
	KFAHIN TEXT IS 'N° Histo par avenant NE PAS UTILISER' , 
