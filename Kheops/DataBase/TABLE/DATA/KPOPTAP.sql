CREATE TABLE ZALBINKHEO.KPOPTAP ( 
--  SQL150B   10   REUSEDLT(*NO) de la table KPOPTAP de ZALBINKHEO ignoré. 
--  SQL1506   30   Clé ou attribut ignoré pour KPOPTAP de ZALBINKHEO. 
...
LABEL ON TABLE ZALBINKHEO.KPOPTAP 
	IS 'KHEOPS Option s''applique à' ; 
  
LABEL ON COLUMN ZALBINKHEO.KPOPTAP 
( KDDID IS 'ID unique' , 
	KDDTYP IS 'Type O/P' , 
	KDDIPB IS 'IPB' , 
	KDDALX IS 'ALX' , 
