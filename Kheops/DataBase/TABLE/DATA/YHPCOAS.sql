CREATE TABLE ZALBINKHEO.YHPCOAS ( 
--  SQL150B   10   REUSEDLT(*NO) de la table YHPCOAS de ZALBINKHEO ignoré. 
...
--  SQL150D   10   EDTCDE ignoré pour la colonne PHALX. 
	PHAVN DECIMAL(3, 0) NOT NULL DEFAULT 0 , 
	PHHIN DECIMAL(3, 0) NOT NULL DEFAULT 0 , 
...
LABEL ON TABLE ZALBINKHEO.YHPCOAS 
	IS 'Histo Polices : Co_assu' ; 
  
LABEL ON COLUMN ZALBINKHEO.YHPCOAS 
( PHIPB IS 'N° de police' , 
	PHALX IS 'N° Aliment' , 
	PHAVN IS 'N° avenant' , 
	PHHIN IS 'N° historique avenan' , 
...
LABEL ON COLUMN ZALBINKHEO.YHPCOAS 
( PHIPB TEXT IS 'N° de Police' , 
	PHALX TEXT IS 'N° Aliment' , 
	PHAVN TEXT IS 'N° avenant' , 
	PHHIN TEXT IS 'N° historique par avenant' , 
	...
	PHTYP TEXT IS 'Type  O Offre  P Police  E à établir' ) ; 
