CREATE TABLE ZALBINKHEO.YHRTFNC ( 
--  SQL150B   10   REUSEDLT(*NO) de la table YHRTFNC de ZALBINKHEO ignoré. 
...
--  SQL150D   10   EDTCDE ignoré pour la colonne JNALX. 
	JNAVN DECIMAL(3, 0) NOT NULL DEFAULT 0 , 
	JNHIN DECIMAL(3, 0) NOT NULL DEFAULT 0 , 
...
LABEL ON TABLE ZALBINKHEO.YHRTFNC 
	IS 'H-Poli.RT:Financement                           JN' ; 
  
LABEL ON COLUMN ZALBINKHEO.YHRTFNC 
( JNIPB IS 'N° de police' , 
	JNALX IS 'N° Aliment' , 
	JNAVN IS 'N° avenant' , 
	JNHIN IS 'N° historique avenan' , 
...
( JNIPB TEXT IS 'N° de Police' , 
	...
	JNAVN TEXT IS 'N° avenant' , 
	JNHIN TEXT IS 'N° historique par avenant' , 
