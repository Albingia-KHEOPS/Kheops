CREATE TABLE ZALBINKHEO.YORTCLA ( 
--  SQL150B   10   REUSEDLT(*NO) de la table YORTCLA de ZALBINKHEO ignoré. 
	QETYP CHAR(1) CCSID 297 NOT NULL DEFAULT '' , 
...
LABEL ON TABLE ZALBINKHEO.YORTCLA 
	IS 'Offre RT : Clauses                              QE' ; 
  
LABEL ON COLUMN ZALBINKHEO.YORTCLA 
( QETYP IS 'Type O/P' , 
	QEIPB IS 'N° Offre / Police' , 
...
LABEL ON COLUMN ZALBINKHEO.YORTCLA 
( QETYP TEXT IS 'Type  O Offre  P Police' , 
	QEIPB TEXT IS 'N° Offre / Police' , 
