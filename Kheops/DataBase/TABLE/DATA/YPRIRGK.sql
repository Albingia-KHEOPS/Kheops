CREATE TABLE ZALBINKHEO.YPRIRGK ( 
--  SQL150B   10   REUSEDLT(*NO) de la table YPRIRGK de ZALBINKHEO ignoré. 
...
LABEL ON TABLE ZALBINKHEO.YPRIRGK 
	IS 'Primes_WR SPK/Gar  Complém                      KV' ; 
  
LABEL ON COLUMN ZALBINKHEO.YPRIRGK 
