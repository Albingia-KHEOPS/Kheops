CREATE TABLE ZALBINKHEO.YPRTOBT ( 
--  SQL150B   10   REUSEDLT(*NO) de la table YPRTOBT de ZALBINKHEO ignoré. 
...
LABEL ON TABLE ZALBINKHEO.YPRTOBT 
	IS 'Poli.RT : Objet TRC                             KF' ; 
  
LABEL ON COLUMN ZALBINKHEO.YPRTOBT 
