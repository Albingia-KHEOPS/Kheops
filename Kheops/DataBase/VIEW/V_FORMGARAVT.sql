CREATE OR REPLACE VIEW ZALBINKHEO.V_FORMGARAVT ( 
	CODEOFFRE , 
	"VERSION" , 
	TYPEOFFRE , 
	CODEFOR , 
	...
	(SELECT OPTV.KDCIPB CODEOFFRE, OPTV.KDCALX VERSION, OPTV.KDCTYP TYPEOFFRE, OPTV.KDCFOR CODEFOR, OPTV.KDCOPT CODEOPT, KAPKAIID CODECIBLE , OPTV.KDCTENG TYPEENRG,  
																		 ...
																		 GARW1.KDECRAVN CREATEAVN1 , GARW1.KDEMAJAVN MAJAVN1 ,  
																		 ( SELECT ZALBINKHEO.F_GTIESORTIE ( CAST ( OPTV.KDCIPB AS VARCHAR ( 9 ) ) , CAST ( OPTV.KDCALX AS INTEGER ) , CAST ( OPTV.KDCTYP AS VARCHAR ( 1 ) ) , CAST ( OPTV.KDCFOR AS INTEGER ) , CAST ( OPTV.KDCOPT AS INTEGER ) , CAST ( GARW1.KDEID AS INTEGER ) ) FROM SYSIBM.SYSDUMMY1 ) DATDEB1 ,  
																		 /* 2016-02-07 : CORRECTION BUG 2246 */  
																		 /* GARW1.KDEDATFIN DATFIN1 , GARW1.KDEHEUFIN HEUFIN1 , GARW1.KDEDUREE DUREE1 , GARW1.KDEDURUNI DURUNI1 , CASE WHEN GARW1.KDEALA = 'B' OR GARW1.KDEALA = 'C' THEN GARW1.KDEALA ELSE GARW1.KDEPALA END ALIMNIV1 ,   */  
																		 GARW1.KDEDATFIN DATFIN1 , GARW1.KDEHEUFIN HEUFIN1 , GARW1.KDEDUREE DUREE1 , GARW1.KDEDURUNI DURUNI1 , GARW1.KDEALA ALIMNIV1 ,  
																		 ...
																		 ( SELECT ZALBINKHEO.F_GTIESORTIE ( CAST ( OPTV.KDCIPB AS VARCHAR ( 9 ) ) , CAST ( OPTV.KDCALX AS INTEGER ) , CAST ( OPTV.KDCTYP AS VARCHAR ( 1 ) ) , CAST ( OPTV.KDCFOR AS INTEGER ) , CAST ( OPTV.KDCOPT AS INTEGER ) , CAST ( GARW3.KDEID AS INTEGER ) ) FROM SYSIBM.SYSDUMMY1 ) DATDEB3 ,  
																									 GARW3.KDEDATFIN DATFIN3 , GARW3.KDEHEUFIN HEUFIN3 , GARW3.KDEDUREE DUREE3 , GARW3.KDEDURUNI DURUNI3 ,  
																		 ...
																		 ( SELECT ZALBINKHEO.F_GTIESORTIE ( CAST ( OPTV.KDCIPB AS VARCHAR ( 9 ) ) , CAST ( OPTV.KDCALX AS INTEGER ) , CAST ( OPTV.KDCTYP AS VARCHAR ( 1 ) ) , CAST ( OPTV.KDCFOR AS INTEGER ) , CAST ( OPTV.KDCOPT AS INTEGER ) , CAST ( GARW4.KDEID AS INTEGER ) ) FROM SYSIBM.SYSDUMMY1 ) DATDEB4 ,  
																									 GARW4.KDEDATFIN DATFIN4 , GARW4.KDEHEUFIN HEUFIN4 , GARW4.KDEDUREE DUREE4 , GARW4.KDEDURUNI DURUNI4 ,  
																		  
																		 ( SELECT COUNT ( * ) FROM ZALBINKHEO.KPOPTAPW WHERE KDDIPB = OPTV.KDCIPB AND KDDALX = OPTV.KDCALX AND KDDTYP = OPTV.KDCTYP AND KDDFOR = OPTV.KDCFOR AND KDDOPT = OPTV.KDCOPT ) APPLIQUEA  
																		  
																		 FROM ZALBINKHEO.KPOPTDW OPTV  
																		 INNER JOIN ZALBINKHEO.KVOLET ON OPTV.KDCKAKID = KAKID  
																		 INNER JOIN ZALBINKHEO.KCATVOLET ON KAKID = KAPKAKID  
																		  
																		 INNER JOIN ZALBINKHEO.KPOPTDW OPTB ON OPTV.KDCIPB = OPTB.KDCIPB AND OPTV.KDCALX = OPTB.KDCALX AND OPTV.KDCTYP = OPTB.KDCTYP  
																		 ...
																		 LEFT JOIN ZALBINKHEO.KPGARAW GARW1 ON GARW1.KDEIPB = OPTB.KDCIPB AND GARW1.KDEALX = OPTB.KDCALX AND GARW1.KDETYP = OPTB.KDCTYP  
																		 ...
																		 LEFT JOIN ZALBINKHEO.KPGARAW GARW2 ON GARW2.KDEIPB = GARW1.KDEIPB AND GARW2.KDEALX = GARW1.KDEALX AND GARW2.KDETYP = GARW1.KDETYP  
																		 ...
																		 LEFT JOIN ZALBINKHEO.KPGARAW GARW3 ON GARW3.KDEIPB = GARW2.KDEIPB AND GARW3.KDEALX = GARW2.KDEALX AND GARW3.KDETYP = GARW2.KDETYP  
																		 ...
																		 LEFT JOIN ZALBINKHEO.KPGARAW GARW4 ON GARW4.KDEIPB = GARW3.KDEIPB AND GARW4.KDEALX = GARW3.KDEALX AND GARW4.KDETYP = GARW3.KDETYP  
...
LABEL ON COLUMN ZALBINKHEO.V_FORMGARAVT 
( CODEOFFRE IS 'IPB' , 
	"VERSION" IS 'ALX' , 
	...
	PARAMNATMODNIV1 IS 'Param Nature modif' , 
	...
	CREATEAVN2 IS 'Avenant de création' , 
	MAJAVN2 IS 'Avenant maj' , 
	...
	PARAMNATMODNIV3 IS 'Param Nature modif' , 
	...
	CREATEAVN3 IS 'Avenant de création' , 
	MAJAVN3 IS 'Avenant maj' , 
	...
	PARAMNATMODNIV4 IS 'Param Nature modif' , 
	...
	CREATEAVN4 IS 'Avenant de création' , 
	MAJAVN4 IS 'Avenant maj' , 
...
( CODEOFFRE TEXT IS 'IPB' , 
	...
	CREATEAVN1 TEXT IS 'Avenant de création' , 
	MAJAVN1 TEXT IS 'Avenant de mise à jour' , 
	DATFIN1 TEXT IS 'Fin de garantie Date' , 
	HEUFIN1 TEXT IS 'Heure Fin' , 
	DUREE1 TEXT IS 'Durée' , 
	DURUNI1 TEXT IS 'Durée Unité' , 
	ALIMNIV1 TEXT IS 'Type d''alimentation' , 
	...
	CREATEAVN2 TEXT IS 'Avenant de création' , 
	MAJAVN2 TEXT IS 'Avenant de mise à jour' , 
	...
	CREATEAVN3 TEXT IS 'Avenant de création' , 
	MAJAVN3 TEXT IS 'Avenant de mise à jour' , 
	...
	CREATEAVN4 TEXT IS 'Avenant de création' , 
	MAJAVN4 TEXT IS 'Avenant de mise à jour' , 
