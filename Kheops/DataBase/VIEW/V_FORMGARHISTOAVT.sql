CREATE OR REPLACE VIEW ZALBINKHEO.V_FORMGARHISTOAVT ( 
	CODEOFFRE , 
	"VERSION" , 
	TYPEOFFRE , 
	CODEAVN , 
	...
	(SELECT OPTV.KDCIPB CODEOFFRE, OPTV.KDCALX VERSION, OPTV.KDCTYP TYPEOFFRE, OPTV.KDCAVN CODEAVN, OPTV.KDCFOR CODEFOR, OPTV.KDCOPT CODEOPT, KAPKAIID CODECIBLE, OPTV.KDCTENG TYPEENRG,  
																		...
																		( SELECT ZALBINKHEO.F_GTIESORTIEHISTO ( CAST ( OPTV.KDCIPB AS VARCHAR ( 9 ) ) , CAST ( OPTV.KDCALX AS INTEGER ) , CAST ( OPTV.KDCTYP AS VARCHAR ( 1 ) ) , CAST ( OPTV.KDCAVN AS INTEGER ) , CAST ( OPTV.KDCFOR AS INTEGER ) , CAST ( OPTV.KDCOPT AS INTEGER ) , CAST ( GARW1.KDEID AS INTEGER ) ) FROM SYSIBM.SYSDUMMY1 ) DATDEB1 , GARW1.KDEDATFIN DATFIN1 , GARW1.KDEHEUFIN HEUFIN1 , GARW1.KDEDUREE DUREE1 , GARW1.KDEDURUNI DURUNI1 ,  
																		...
																		( SELECT ZALBINKHEO.F_GTIESORTIEHISTO ( CAST ( OPTV.KDCIPB AS VARCHAR ( 9 ) ) , CAST ( OPTV.KDCALX AS INTEGER ) , CAST ( OPTV.KDCTYP AS VARCHAR ( 1 ) ) , CAST ( OPTV.KDCAVN AS INTEGER ) , CAST ( OPTV.KDCFOR AS INTEGER ) , CAST ( OPTV.KDCOPT AS INTEGER ) , CAST ( GARW2.KDEID AS INTEGER ) ) FROM SYSIBM.SYSDUMMY1 ) DATDEB2 , GARW2.KDEDATFIN DATFIN2 , GARW2.KDEHEUFIN HEUFIN2 , GARW2.KDEDUREE DUREE2 , GARW2.KDEDURUNI DURUNI2 ,  
																		...
																		( SELECT ZALBINKHEO.F_GTIESORTIEHISTO ( CAST ( OPTV.KDCIPB AS VARCHAR ( 9 ) ) , CAST ( OPTV.KDCALX AS INTEGER ) , CAST ( OPTV.KDCTYP AS VARCHAR ( 1 ) ) , CAST ( OPTV.KDCAVN AS INTEGER ) , CAST ( OPTV.KDCFOR AS INTEGER ) , CAST ( OPTV.KDCOPT AS INTEGER ) , CAST ( GARW3.KDEID AS INTEGER ) ) FROM SYSIBM.SYSDUMMY1 ) DATDEB3 , GARW3.KDEDATFIN DATFIN3 , GARW3.KDEHEUFIN HEUFIN3 , GARW3.KDEDUREE DUREE3 , GARW3.KDEDURUNI DURUNI3 ,  
																		...
																		( SELECT ZALBINKHEO.F_GTIESORTIEHISTO ( CAST ( OPTV.KDCIPB AS VARCHAR ( 9 ) ) , CAST ( OPTV.KDCALX AS INTEGER ) , CAST ( OPTV.KDCTYP AS VARCHAR ( 1 ) ) , CAST ( OPTV.KDCAVN AS INTEGER ) , CAST ( OPTV.KDCFOR AS INTEGER ) , CAST ( OPTV.KDCOPT AS INTEGER ) , CAST ( GARW4.KDEID AS INTEGER ) ) FROM SYSIBM.SYSDUMMY1 ) DATDEB4 , GARW4.KDEDATFIN DATFIN4 , GARW4.KDEHEUFIN HEUFIN4 , GARW4.KDEDUREE DUREE4 , GARW4.KDEDURUNI DURUNI4 ,  
...
LABEL ON COLUMN ZALBINKHEO.V_FORMGARHISTOAVT 
( CODEOFFRE IS 'IPB' , 
	"VERSION" IS 'ALX' , 
