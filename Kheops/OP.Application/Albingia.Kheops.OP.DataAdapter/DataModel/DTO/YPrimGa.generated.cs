...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.DTO {
    // ZALBINKHEO.YPRIMGA
    public partial class YPrimGa  {
             //YPRIMGA

            ///<summary>Public empty contructor</summary>
            public YPrimGa() {}
            ///<summary>Public empty contructor</summary>
            public YPrimGa(YPrimGa copyFrom) 
            {
                  this.Plipb= copyFrom.Plipb;
                  this.Plalx= copyFrom.Plalx;
                  this.Plipk= copyFrom.Plipk;
                  ...
                  this.Plgrh= copyFrom.Plgrh;
                  this.Plkrh= copyFrom.Plkrh;
            ...
            ///<summary> GAREAT Recalcul Montant HT (HorsCN) </summary>
            public Decimal Plgrh { get; set; } 
            
            ///<summary> GAREAT Recalcul Mnt HT      Dev CPT </summary>
            public Decimal Plkrh { get; set; } 
  


        public override bool Equals(object  obj)
        {
            YPrimGa  x=this,  y=obj as YPrimGa;
            if( y == default(YPrimGa) ) return false;
            return (
                    x.Plipb==y.Plipb
                    && x.Plalx==y.Plalx
                    && x.Plipk==y.Plipk
            ...
            unchecked {
              return 
                   (((((((((((((((((((((((((((
                      ...
                      * 23 ) + (this.Plgrh.GetHashCode() ) 
                      * 23 ) + (this.Plkrh.GetHashCode() )                    );
           }
        }
    }
}
