...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository
{
    ...
    public partial class HpisvalRepository : BaseTableRepository
    {
...
WHERE KKCID = :KKCID
";
        const string update = @"UPDATE HPISVAL SET 
...
, KKCKGBNMID = :KKCKGBNMID, KKCVDEC = :KKCVDEC, KKCVUN = :KKCVUN, KKCVDATD = :KKCVDATD, KKCVHEUD = :KKCVHEUD, KKCVDATF = :KKCVDATF, KKCVHEUF = :KKCVHEUF, KKCVTXT = :KKCVTXT, KKCKFBID = :KKCKFBID, KKCISVAL = :KKCISVAL
 ...
 WHERE 
KKCID = :KKCID";
        const string delete = @"DELETE FROM HPISVAL WHERE KKCID = :KKCID";
        const string insert = @"INSERT INTO  HPISVAL (
KKCID, KKCTYP, KKCIPB, KKCALX, KKCAVN
, KKCHIN, KKCRSQ, KKCOBJ, KKCFOR, KKCOPT
, KKCKGBNMID, KKCVDEC, KKCVUN, KKCVDATD, KKCVHEUD
, KKCVDATF, KKCVHEUF, KKCVTXT, KKCKFBID, KKCISVAL
...
";
        ...
        public HpisvalRepository(IDbConnection connection, IdentifierGenerator idGenerator) : base(connection)
        {
        ...
        public IEnumerable<KPISVal> GetByAffaire(string KKCTYP, string KKCIPB, int KKCALX, int KKCAVN)
        {
            return connection.EnsureOpened().Query<KPISVal>(select_GetByAffaire, new { KKCTYP, KKCIPB, KKCALX, KKCAVN }).ToList();
        }
    }
}
