...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  HpcotisRepository : BaseTableRepository {
...
, KDMAVN, KDMHIN, KDMATGMHT, KDMATGKHT, KDMATGMTX
, KDMATGKTX, KDMATGMTT, KDMATGKTT, KDMATGCOT, KDMATGKCO
, KDMCNABAS, KDMCNAKBS, KDMCNAMHT, KDMCNAKHT, KDMCNAMTX
, KDMCNAKTX, KDMCNAMTT, KDMCNAKTT, KDMCNACOB, KDMCNACNC
, KDMCNATXF, KDMCNACNM, KDMCNACMF, KDMCNAKCM, KDMGARMHT
, KDMGARMTX, KDMGARMTT, KDMHFMHT, KDMHFFLAG, KDMHFMHF
, KDMHFMTX, KDMHFMTT, KDMAFRB, KDMAFR, KDMKFA
, KDMAFT, KDMKFT, KDMFGA, KDMKFG, KDMMHT
, KDMMHFLAG, KDMMHF, KDMKHT, KDMMTX, KDMKTX
, KDMMTT, KDMMTFLAG, KDMTTF, KDMKTT, KDMCOB
, KDMCOM, KDMCMF, KDMCOT, KDMCOF, KDMKCO
, KDMCOEFC FROM HPCOTIS
WHERE KDMTYP = :KDMTYP
and KDMIPB = :KDMIPB
and KDMALX = :KDMALX
and KDMAVN = :KDMAVN
...
and KDMID = :KDMID
";
            const string update=@"UPDATE HPCOTIS SET 
KDMID = :KDMID, KDMTAP = :KDMTAP, KDMTYP = :KDMTYP, KDMIPB = :KDMIPB, KDMALX = :KDMALX, KDMAVN = :KDMAVN, KDMHIN = :KDMHIN, KDMATGMHT = :KDMATGMHT, KDMATGKHT = :KDMATGKHT, KDMATGMTX = :KDMATGMTX
, KDMATGKTX = :KDMATGKTX, KDMATGMTT = :KDMATGMTT, KDMATGKTT = :KDMATGKTT, KDMATGCOT = :KDMATGCOT, KDMATGKCO = :KDMATGKCO, KDMCNABAS = :KDMCNABAS, KDMCNAKBS = :KDMCNAKBS, KDMCNAMHT = :KDMCNAMHT, KDMCNAKHT = :KDMCNAKHT, KDMCNAMTX = :KDMCNAMTX
, KDMCNAKTX = :KDMCNAKTX, KDMCNAMTT = :KDMCNAMTT, KDMCNAKTT = :KDMCNAKTT, KDMCNACOB = :KDMCNACOB, KDMCNACNC = :KDMCNACNC, KDMCNATXF = :KDMCNATXF, KDMCNACNM = :KDMCNACNM, KDMCNACMF = :KDMCNACMF, KDMCNAKCM = :KDMCNAKCM, KDMGARMHT = :KDMGARMHT
, KDMGARMTX = :KDMGARMTX, KDMGARMTT = :KDMGARMTT, KDMHFMHT = :KDMHFMHT, KDMHFFLAG = :KDMHFFLAG, KDMHFMHF = :KDMHFMHF, KDMHFMTX = :KDMHFMTX, KDMHFMTT = :KDMHFMTT, KDMAFRB = :KDMAFRB, KDMAFR = :KDMAFR, KDMKFA = :KDMKFA
, KDMAFT = :KDMAFT, KDMKFT = :KDMKFT, KDMFGA = :KDMFGA, KDMKFG = :KDMKFG, KDMMHT = :KDMMHT, KDMMHFLAG = :KDMMHFLAG, KDMMHF = :KDMMHF, KDMKHT = :KDMKHT, KDMMTX = :KDMMTX, KDMKTX = :KDMKTX
, KDMMTT = :KDMMTT, KDMMTFLAG = :KDMMTFLAG, KDMTTF = :KDMTTF, KDMKTT = :KDMKTT, KDMCOB = :KDMCOB, KDMCOM = :KDMCOM, KDMCMF = :KDMCMF, KDMCOT = :KDMCOT, KDMCOF = :KDMCOF, KDMKCO = :KDMKCO
, KDMCOEFC = :KDMCOEFC
 WHERE 
KDMTYP = :KDMTYP and KDMIPB = :KDMIPB and KDMALX = :KDMALX and KDMAVN = :KDMAVN and KDMHIN = :KDMHIN and KDMTAP = :KDMTAP and KDMID = :KDMID";
            const string delete=@"DELETE FROM HPCOTIS WHERE KDMTYP = :KDMTYP AND KDMIPB = :KDMIPB AND KDMALX = :KDMALX AND KDMAVN = :KDMAVN AND KDMHIN = :KDMHIN AND KDMTAP = :KDMTAP AND KDMID = :KDMID";
            const string insert=@"INSERT INTO  HPCOTIS (
KDMID, KDMTAP, KDMTYP, KDMIPB, KDMALX
, KDMAVN, KDMHIN, KDMATGMHT, KDMATGKHT, KDMATGMTX
, KDMATGKTX, KDMATGMTT, KDMATGKTT, KDMATGCOT, KDMATGKCO
, KDMCNABAS, KDMCNAKBS, KDMCNAMHT, KDMCNAKHT, KDMCNAMTX
...
";
            ...
            public HpcotisRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public KpCotis Get(string KDMTYP, string KDMIPB, int KDMALX, int KDMAVN, int KDMHIN, string KDMTAP, Int64 KDMID){
                return connection.Query<KpCotis>(select, new {KDMTYP, KDMIPB, KDMALX, KDMAVN, KDMHIN, KDMTAP, KDMID}).SingleOrDefault();
            }
            ...
            public void Insert(KpCotis value){
                    ...
                    parameters.Add("KDMAVN",value.Kdmavn, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
                    parameters.Add("KDMHIN",value.Kdmhin, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
            ...
            public void Delete(KpCotis value){
                    ...
                    parameters.Add("KDMAVN",value.Kdmavn);
                    parameters.Add("KDMHIN",value.Kdmhin);
            ...
            public IEnumerable<KpCotis> GetByAffaire(string KDMTYP, string KDMIPB, int KDMALX, int KDMAVN){
                    return connection.EnsureOpened().Query<KpCotis>(select_GetByAffaire, new {KDMTYP, KDMIPB, KDMALX, KDMAVN}).ToList();
            }
    }
}
