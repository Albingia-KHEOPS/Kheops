...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  HpinvedRepository : BaseTableRepository {
...
KBFID, KBFTYP, KBFIPB, KBFALX, KBFAVN
, KBFHIN, KBFKBEID, KBFNUMLGN, KBFDESC, KBFKADID
, KBFSITE, KBFNTLI, KBFCP, KBFVILLE, KBFADH
, KBFDATDEB, KBFDEBHEU, KBFDATFIN, KBFFINHEU, KBFMNT1
, KBFMNT2, KBFNBEVN, KBFNBPER, KBFNOM, KBFPNOM
, KBFDATNAI, KBFFONC, KBFCDEC, KBFCIP, KBFACCS
, KBFAVPR, KBFMSR, KBFCMAT, KBFSEX, KBFMDQ
, KBFMDA, KBFACTP, KBFKADFH, KBFEXT, KBFMNT3
, KBFMNT4, KBFQUA, KBFREN, KBFRLO, KBFPAY
, KBFSIT2, KBFADH2, KBFSIT3, KBFADH3, KBFDES2
, KBFDES3, KBFDES4, KBFMRQ, KBFMOD, KBFIMM
 FROM HPINVED
WHERE KBFID = :parKBFID
";
            const string update=@"UPDATE HPINVED SET 
KBFID = :KBFID, KBFTYP = :KBFTYP, KBFIPB = :KBFIPB, KBFALX = :KBFALX, KBFAVN = :KBFAVN, KBFHIN = :KBFHIN, KBFKBEID = :KBFKBEID, KBFNUMLGN = :KBFNUMLGN, KBFDESC = :KBFDESC, KBFKADID = :KBFKADID
, KBFSITE = :KBFSITE, KBFNTLI = :KBFNTLI, KBFCP = :KBFCP, KBFVILLE = :KBFVILLE, KBFADH = :KBFADH, KBFDATDEB = :KBFDATDEB, KBFDEBHEU = :KBFDEBHEU, KBFDATFIN = :KBFDATFIN, KBFFINHEU = :KBFFINHEU, KBFMNT1 = :KBFMNT1
, KBFMNT2 = :KBFMNT2, KBFNBEVN = :KBFNBEVN, KBFNBPER = :KBFNBPER, KBFNOM = :KBFNOM, KBFPNOM = :KBFPNOM, KBFDATNAI = :KBFDATNAI, KBFFONC = :KBFFONC, KBFCDEC = :KBFCDEC, KBFCIP = :KBFCIP, KBFACCS = :KBFACCS
, KBFAVPR = :KBFAVPR, KBFMSR = :KBFMSR, KBFCMAT = :KBFCMAT, KBFSEX = :KBFSEX, KBFMDQ = :KBFMDQ, KBFMDA = :KBFMDA, KBFACTP = :KBFACTP, KBFKADFH = :KBFKADFH, KBFEXT = :KBFEXT, KBFMNT3 = :KBFMNT3
, KBFMNT4 = :KBFMNT4, KBFQUA = :KBFQUA, KBFREN = :KBFREN, KBFRLO = :KBFRLO, KBFPAY = :KBFPAY, KBFSIT2 = :KBFSIT2, KBFADH2 = :KBFADH2, KBFSIT3 = :KBFSIT3, KBFADH3 = :KBFADH3, KBFDES2 = :KBFDES2
, KBFDES3 = :KBFDES3, KBFDES4 = :KBFDES4, KBFMRQ = :KBFMRQ, KBFMOD = :KBFMOD, KBFIMM = :KBFIMM
 WHERE 
KBFID = :parKBFID";
            const string delete=@"DELETE FROM HPINVED WHERE KBFID = :parKBFID";
            const string insert=@"INSERT INTO  HPINVED (
KBFID, KBFTYP, KBFIPB, KBFALX, KBFAVN
, KBFHIN, KBFKBEID, KBFNUMLGN, KBFDESC, KBFKADID
, KBFSITE, KBFNTLI, KBFCP, KBFVILLE, KBFADH
, KBFDATDEB, KBFDEBHEU, KBFDATFIN, KBFFINHEU, KBFMNT1
...
";
            ...
            public HpinvedRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
            ...
            public void Insert(KpInveD value){
                    ...
                    parameters.Add("KBFAVN",value.Kbfavn, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
                    parameters.Add("KBFHIN",value.Kbfhin, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
                    ...
                    parameters.Add("KBFIMM",value.Kbfimm??String.Empty, dbType:DbType.AnsiStringFixedLength, direction:ParameterDirection.Input, size:20, scale: 0);
            ...
            public IEnumerable<KpInveD> GetByAffaire(string typeAffaire, string codeAffaire, int numeroAliement, int numeroAvenant){
                    return connection.EnsureOpened().Query<KpInveD>(select_GetByAffaire, new {typeAffaire, codeAffaire, numeroAliement, numeroAvenant}).ToList();
            }
            public IEnumerable<KpInveD> GetByInven(Int64 invenId, int numeroAvenant){
                    return connection.EnsureOpened().Query<KpInveD>(select_GetByInven, new {invenId, numeroAvenant}).ToList();
            }
    }
}
