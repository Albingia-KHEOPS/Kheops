...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  HpoptRepository : BaseTableRepository {
...
KDBID, KDBTYP, KDBIPB, KDBALX, KDBAVN
, KDBHIN, KDBFOR, KDBKDAID, KDBOPT, KDBDESC
, KDBFORR, KDBKDAIDR, KDBSPEID, KDBCRU, KDBCRD
, KDBCRH, KDBMAJU, KDBMAJD, KDBMAJH, KDBPAQ
, KDBACQ, KDBTMC, KDBTFF, KDBTFP, KDBPRO
, KDBTMI, KDBTFM, KDBCMC, KDBCFO, KDBCHT
, KDBCTT, KDBCCP, KDBVAL, KDBVAA, KDBVAW
, KDBVAT, KDBVAU, KDBVAH, KDBIVO, KDBIVA
, KDBIVW, KDBAVE, KDBAVG, KDBECO, KDBAVA
, KDBAVM, KDBAVJ, KDBEHH, KDBEHC, KDBEHI
, KDBASVALO, KDBASVALA, KDBASVALW, KDBASUNIT, KDBASBASE
, KDBGER FROM HPOPT
WHERE KDBID = :id
and KDBAVN = :numeroAvenant
";
            const string update=@"UPDATE HPOPT SET 
KDBID = :KDBID, KDBTYP = :KDBTYP, KDBIPB = :KDBIPB, KDBALX = :KDBALX, KDBAVN = :KDBAVN, KDBHIN = :KDBHIN, KDBFOR = :KDBFOR, KDBKDAID = :KDBKDAID, KDBOPT = :KDBOPT, KDBDESC = :KDBDESC
, KDBFORR = :KDBFORR, KDBKDAIDR = :KDBKDAIDR, KDBSPEID = :KDBSPEID, KDBCRU = :KDBCRU, KDBCRD = :KDBCRD, KDBCRH = :KDBCRH, KDBMAJU = :KDBMAJU, KDBMAJD = :KDBMAJD, KDBMAJH = :KDBMAJH, KDBPAQ = :KDBPAQ
, KDBACQ = :KDBACQ, KDBTMC = :KDBTMC, KDBTFF = :KDBTFF, KDBTFP = :KDBTFP, KDBPRO = :KDBPRO, KDBTMI = :KDBTMI, KDBTFM = :KDBTFM, KDBCMC = :KDBCMC, KDBCFO = :KDBCFO, KDBCHT = :KDBCHT
, KDBCTT = :KDBCTT, KDBCCP = :KDBCCP, KDBVAL = :KDBVAL, KDBVAA = :KDBVAA, KDBVAW = :KDBVAW, KDBVAT = :KDBVAT, KDBVAU = :KDBVAU, KDBVAH = :KDBVAH, KDBIVO = :KDBIVO, KDBIVA = :KDBIVA
, KDBIVW = :KDBIVW, KDBAVE = :KDBAVE, KDBAVG = :KDBAVG, KDBECO = :KDBECO, KDBAVA = :KDBAVA, KDBAVM = :KDBAVM, KDBAVJ = :KDBAVJ, KDBEHH = :KDBEHH, KDBEHC = :KDBEHC, KDBEHI = :KDBEHI
, KDBASVALO = :KDBASVALO, KDBASVALA = :KDBASVALA, KDBASVALW = :KDBASVALW, KDBASUNIT = :KDBASUNIT, KDBASBASE = :KDBASBASE, KDBGER = :KDBGER
 WHERE 
KDBID = :id and KDBAVN = :numeroAvenant";
            const string delete=@"DELETE FROM HPOPT WHERE KDBID = :id AND KDBAVN = :numeroAvenant";
            const string insert=@"INSERT INTO  HPOPT (
KDBID, KDBTYP, KDBIPB, KDBALX, KDBAVN
, KDBHIN, KDBFOR, KDBKDAID, KDBOPT, KDBDESC
, KDBFORR, KDBKDAIDR, KDBSPEID, KDBCRU, KDBCRD
, KDBCRH, KDBMAJU, KDBMAJD, KDBMAJH, KDBPAQ
...
, KDBGER FROM HPOPT
WHERE KDBTYP = :type
and KDBIPB = :numeroAffaire
and KDBALX = :numeroAliment
and KDBAVN = :numeroAvenant
";
...
, KDBASVALO, KDBASVALA, KDBASVALW, KDBASUNIT, KDBASBASE
, KDBGER FROM HPOPT
WHERE KDBIPB = :parKDBIPB
and KDBALX = :parKDBALX
";
            #endregion

            public HpoptRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public KpOpt Get(Int64 id, int numeroAvenant){
                return connection.Query<KpOpt>(select, new {id, numeroAvenant}).SingleOrDefault();
            }
            ...
            public void Insert(KpOpt value){
                    ...
                    parameters.Add("KDBAVN",value.Kdbavn, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
                    parameters.Add("KDBHIN",value.Kdbhin, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
            ...
            public void Delete(KpOpt value){
                    ...
                    parameters.Add("numeroAvenant",value.Kdbavn);
            ...
            public IEnumerable<KpOpt> GetByAffaire(string type, string numeroAffaire, int numeroAliment, int numeroAvenant){
                    return connection.EnsureOpened().Query<KpOpt>(select_GetByAffaire, new {type, numeroAffaire, numeroAliment, numeroAvenant}).ToList();
            }
            public IEnumerable<KpOpt> GetByFormule(Int64 idFormule, int numeroAvenant){
                    return connection.EnsureOpened().Query<KpOpt>(select_GetByFormule, new {idFormule, numeroAvenant}).ToList();
            }
            public IEnumerable<KpOpt> GetByIpbAlx(string parKDBIPB, int parKDBALX){
                    return connection.EnsureOpened().Query<KpOpt>(select_GetByIpbAlx, new {parKDBIPB, parKDBALX}).ToList();
            }
    }
}
