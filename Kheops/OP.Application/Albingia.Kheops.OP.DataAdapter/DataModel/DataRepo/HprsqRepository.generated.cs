...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  HprsqRepository : BaseTableRepository {
...
KABTYP, KABIPB, KABALX, KABAVN, KABHIN
, KABRSQ, KABCIBLE, KABDESC, KABDESI, KABOBSV
, KABREPVAL, KABREPOBL, KABAPE, KABTRE, KABCLASS
, KABNMC01, KABNMC02, KABNMC03, KABNMC04, KABNMC05
, KABMAND, KABMANF, KABDSPP, KABLCIVALO, KABLCIVALA
, KABLCIVALW, KABLCIUNIT, KABLCIBASE, KABKDIID, KABFRHVALO
, KABFRHVALA, KABFRHVALW, KABFRHUNIT, KABFRHBASE, KABKDKID
, KABNSIR, KABMANDH, KABMANFH, KABSURF, KABVMC
, KABPROL, KABPBI, KABBRNT, KABBRNC FROM HPRSQ
WHERE KABTYP = :typeAffaire
and KABIPB = :numeroAffaire
and KABALX = :numeroAliment
and KABRSQ = :numeroRisque
and KABAVN = :numeroAvenant
";
            const string update=@"UPDATE HPRSQ SET 
KABTYP = :KABTYP, KABIPB = :KABIPB, KABALX = :KABALX, KABAVN = :KABAVN, KABHIN = :KABHIN, KABRSQ = :KABRSQ, KABCIBLE = :KABCIBLE, KABDESC = :KABDESC, KABDESI = :KABDESI, KABOBSV = :KABOBSV
, KABREPVAL = :KABREPVAL, KABREPOBL = :KABREPOBL, KABAPE = :KABAPE, KABTRE = :KABTRE, KABCLASS = :KABCLASS, KABNMC01 = :KABNMC01, KABNMC02 = :KABNMC02, KABNMC03 = :KABNMC03, KABNMC04 = :KABNMC04, KABNMC05 = :KABNMC05
, KABMAND = :KABMAND, KABMANF = :KABMANF, KABDSPP = :KABDSPP, KABLCIVALO = :KABLCIVALO, KABLCIVALA = :KABLCIVALA, KABLCIVALW = :KABLCIVALW, KABLCIUNIT = :KABLCIUNIT, KABLCIBASE = :KABLCIBASE, KABKDIID = :KABKDIID, KABFRHVALO = :KABFRHVALO
, KABFRHVALA = :KABFRHVALA, KABFRHVALW = :KABFRHVALW, KABFRHUNIT = :KABFRHUNIT, KABFRHBASE = :KABFRHBASE, KABKDKID = :KABKDKID, KABNSIR = :KABNSIR, KABMANDH = :KABMANDH, KABMANFH = :KABMANFH, KABSURF = :KABSURF, KABVMC = :KABVMC
, KABPROL = :KABPROL, KABPBI = :KABPBI, KABBRNT = :KABBRNT, KABBRNC = :KABBRNC
 WHERE 
KABTYP = :typeAffaire and KABIPB = :numeroAffaire and KABALX = :numeroAliment and KABRSQ = :numeroRisque and KABAVN = :numeroAvenant";
            const string delete=@"DELETE FROM HPRSQ WHERE KABTYP = :typeAffaire AND KABIPB = :numeroAffaire AND KABALX = :numeroAliment AND KABRSQ = :numeroRisque AND KABAVN = :numeroAvenant";
            const string insert=@"INSERT INTO  HPRSQ (
KABTYP, KABIPB, KABALX, KABAVN, KABHIN
, KABRSQ, KABCIBLE, KABDESC, KABDESI, KABOBSV
, KABREPVAL, KABREPOBL, KABAPE, KABTRE, KABCLASS
, KABNMC01, KABNMC02, KABNMC03, KABNMC04, KABNMC05
...
, KABFRHVALA, KABFRHVALW, KABFRHUNIT, KABFRHBASE, KABKDKID
, KABNSIR, KABMANDH, KABMANFH, KABSURF, KABVMC
, KABPROL, KABPBI, KABBRNT, KABBRNC
) VALUES (
:KABTYP, :KABIPB, :KABALX, :KABAVN, :KABHIN
, :KABRSQ, :KABCIBLE, :KABDESC, :KABDESI, :KABOBSV
, :KABREPVAL, :KABREPOBL, :KABAPE, :KABTRE, :KABCLASS
...
, KABNSIR, KABMANDH, KABMANFH, KABSURF, KABVMC
, KABPROL, KABPBI, KABBRNT, KABBRNC FROM HPRSQ
WHERE KABIPB = :parKABIPB
and KABALX = :parKABALX
";
            #endregion

            public HprsqRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public KpRsq Get(string typeAffaire, string numeroAffaire, int numeroAliment, int numeroRisque, int numeroAvenant){
                return connection.Query<KpRsq>(select, new {typeAffaire, numeroAffaire, numeroAliment, numeroRisque, numeroAvenant}).SingleOrDefault();
            }
            ...
            public void Insert(KpRsq value){
                    ...
                    parameters.Add("KABAVN",value.Kabavn, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
                    parameters.Add("KABHIN",value.Kabhin, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
            ...
            public void Delete(KpRsq value){
                    ...
                    parameters.Add("numeroAliment",value.Kabalx);
                    parameters.Add("numeroRisque",value.Kabrsq);
                    parameters.Add("numeroAvenant",value.Kabavn);
            ...
            public IEnumerable<KpRsq> Liste(string typeAffaire, string numeroAffaire, int numeroAliment, int numeroAvenant){
                    return connection.EnsureOpened().Query<KpRsq>(select_Liste, new {typeAffaire, numeroAffaire, numeroAliment, numeroAvenant}).ToList();
            }
            public IEnumerable<KpRsq> GetAllByIpbAlx(string parKABIPB, int parKABALX){
                    return connection.EnsureOpened().Query<KpRsq>(select_GetAllByIpbAlx, new {parKABIPB, parKABALX}).ToList();
            }
    }
}
