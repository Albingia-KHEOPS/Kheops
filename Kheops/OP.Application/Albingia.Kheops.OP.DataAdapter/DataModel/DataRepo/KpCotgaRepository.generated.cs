...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  KpCotgaRepository : BaseTableRepository {
...
KDNID, KDNTYP, KDNIPB, KDNALX, KDNFOR
, KDNFOA, KDNOPT, KDNGARAN, KDNKDEID, KDNNUMTAR
, KDNKDGID, KDNTAROK, KDNKDMID, KDNRSQ, KDNTRI
, KDNHT, KDNHF, KDNKH, KDNMHT, KDNKHT
, KDNMTX, KDNKTX, KDNTTC, KDNTTF, KDNMTT
, KDNKTC, KDNCOT, KDNKCO, KDNCNAMHT, KDNCNAKHT
, KDNCNAMTX, KDNCNAKTX, KDNCNAMTT, KDNCNAKTT, KDNCNACOM
, KDNCNAKCM, KDNATGMHT, KDNATGKHT, KDNATGMTX, KDNATGKTX
, KDNATGMTT, KDNATGKTT FROM KPCOTGA
WHERE KDNTYP = :KDNTYP
and KDNIPB = :KDNIPB
and KDNALX = :KDNALX
and KDNID = :KDNID
";
            const string update=@"UPDATE KPCOTGA SET 
KDNID = :KDNID, KDNTYP = :KDNTYP, KDNIPB = :KDNIPB, KDNALX = :KDNALX, KDNFOR = :KDNFOR, KDNFOA = :KDNFOA, KDNOPT = :KDNOPT, KDNGARAN = :KDNGARAN, KDNKDEID = :KDNKDEID, KDNNUMTAR = :KDNNUMTAR
, KDNKDGID = :KDNKDGID, KDNTAROK = :KDNTAROK, KDNKDMID = :KDNKDMID, KDNRSQ = :KDNRSQ, KDNTRI = :KDNTRI, KDNHT = :KDNHT, KDNHF = :KDNHF, KDNKH = :KDNKH, KDNMHT = :KDNMHT, KDNKHT = :KDNKHT
, KDNMTX = :KDNMTX, KDNKTX = :KDNKTX, KDNTTC = :KDNTTC, KDNTTF = :KDNTTF, KDNMTT = :KDNMTT, KDNKTC = :KDNKTC, KDNCOT = :KDNCOT, KDNKCO = :KDNKCO, KDNCNAMHT = :KDNCNAMHT, KDNCNAKHT = :KDNCNAKHT
, KDNCNAMTX = :KDNCNAMTX, KDNCNAKTX = :KDNCNAKTX, KDNCNAMTT = :KDNCNAMTT, KDNCNAKTT = :KDNCNAKTT, KDNCNACOM = :KDNCNACOM, KDNCNAKCM = :KDNCNAKCM, KDNATGMHT = :KDNATGMHT, KDNATGKHT = :KDNATGKHT, KDNATGMTX = :KDNATGMTX, KDNATGKTX = :KDNATGKTX
, KDNATGMTT = :KDNATGMTT, KDNATGKTT = :KDNATGKTT
 WHERE 
KDNTYP = :KDNTYP and KDNIPB = :KDNIPB and KDNALX = :KDNALX and KDNID = :KDNID";
            const string delete=@"DELETE FROM KPCOTGA WHERE KDNTYP = :KDNTYP AND KDNIPB = :KDNIPB AND KDNALX = :KDNALX AND KDNID = :KDNID";
            const string insert=@"INSERT INTO  KPCOTGA (
KDNID, KDNTYP, KDNIPB, KDNALX, KDNFOR
, KDNFOA, KDNOPT, KDNGARAN, KDNKDEID, KDNNUMTAR
, KDNKDGID, KDNTAROK, KDNKDMID, KDNRSQ, KDNTRI
, KDNHT, KDNHF, KDNKH, KDNMHT, KDNKHT
...
";
            ...
            public KpCotgaRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public KpCotga Get(string KDNTYP, string KDNIPB, int KDNALX, Int64 KDNID){
                return connection.Query<KpCotga>(select, new {KDNTYP, KDNIPB, KDNALX, KDNID}).SingleOrDefault();
            }
            ...
            public IEnumerable<KpCotga> GetByAffaire(string KDNTYP, string KDNIPB, int KDNALX){
                    return connection.EnsureOpened().Query<KpCotga>(select_GetByAffaire, new {KDNTYP, KDNIPB, KDNALX}).ToList();
            }
    }
}
