...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  KpDocLDRepository : BaseTableRepository {
...
, KEMENVD, KEMENVH FROM KPDOCLD
WHERE KEMID = :KEMID
";
            const string update=@"UPDATE KPDOCLD SET 
...
, KEMSTU = :KEMSTU, KEMSIT = :KEMSIT, KEMSTD = :KEMSTD, KEMSTH = :KEMSTH, KEMENVU = :KEMENVU, KEMENVD = :KEMENVD, KEMENVH = :KEMENVH
 WHERE 
KEMID = :KEMID";
            const string delete=@"DELETE FROM KPDOCLD WHERE KEMID = :KEMID";
            const string insert=@"INSERT INTO  KPDOCLD (
KEMID, KEMKELID, KEMORD, KEMTYPD, KEMTYPL
, KEMTYENV, KEMTAMP, KEMTYDS, KEMTYI, KEMIDS
, KEMDSTP, KEMINL, KEMNBEX, KEMDOCA, KEMTYDIF
, KEMLMAI, KEMAEMO, KEMAEM, KEMKESID, KEMNTA
...
, KEMSTU, KEMSIT, KEMSTD, KEMSTH, KEMENVU
, KEMENVD, KEMENVH FROM KPDOCLD
INNER JOIN KPDOCL ON KEMKELID=KELID
...
";
            ...
            public KpDocLDRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
