...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  KpDocRepository : BaseTableRepository {
...
, KEQSTG, KEQDIMP FROM KPDOC
WHERE KEQID = :id
";
            const string update=@"UPDATE KPDOC SET 
...
, KEQSTG = :KEQSTG, KEQDIMP = :KEQDIMP
 WHERE 
KEQID = :id";
            const string delete=@"DELETE FROM KPDOC WHERE KEQID = :id";
            const string insert=@"INSERT INTO  KPDOC (
KEQID, KEQTYP, KEQIPB, KEQALX, KEQSUA
, KEQNUM, KEQSBR, KEQSERV, KEQACTG, KEQACTN
, KEQECO, KEQAVN, KEQETAP, KEQKEMID, KEQORD
, KEQTGL, KEQTDOC, KEQKESID, KEQAJT, KEQTRS
...
";
            ...
            public KpDocRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
