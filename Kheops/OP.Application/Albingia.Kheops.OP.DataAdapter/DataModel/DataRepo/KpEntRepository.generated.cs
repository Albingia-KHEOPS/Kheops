...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  KpEntRepository : BaseTableRepository {
...
KAATYP, KAAIPB, KAAALX, KAABONI, KAABONT
, KAAANTI, KAADESI, KAAOBSV, KAALCIVALO, KAALCIVALA
, KAALCIVALW, KAALCIUNIT, KAALCIBASE, KAAKDIID, KAAFRHVALO
, KAAFRHVALA, KAAFRHVALW, KAAFRHUNIT, KAAFRHBASE, KAAKDKID
, KAAATGLCI, KAAATGKLC, KAAATGCAP, KAAATGKCA, KAAATGSUR
, KAAATGBCN, KAAATGKBC, KAAATGCRI, KAAATGAPT, KAAATGF
, KAAATGAPR, KAAATGTRT, KAAATGTRR, KAAATGTCT, KAAATGTCR
, KAAATGTFT, KAAATGTCM, KAAATGTFA, KAAATGCTX, KAAATGLCF
, KAAATGCAF, KAAATGSUF, KAAATGBCF, KAALCIINA, KAAATGFRR
, KAAATGCMT, KAAATGFAT, KAAATGBAS, KAAATGKBA, KAAFRHINA
, KAAAND, KAADPRJ, KAADSTA, KAAOBSF, KAAOBSA
, KAAOBSC, KAAASS, KAAAFS, KAAXCMS, KAACNCS
, KAACIBLE, KAAMAXA, KAAMAXE, KAAIDE, KAAIMED
, KAAIMDA, KAAISIN, KAAAVH, KAAAVDS, KAARCP
, KAAPAQ, KAALTASP, KAASCAT, KAARELDT, KAAQUACH
, KAAQUVEN, KAAAVAO, KAAARIPK, KAAARTYG, KAAPKRD
, KAASUDD, KAASUDH, KAASUFD, KAASUFH, KAARSDD
, KAARSDH, KAAATTDOC FROM KPENT
WHERE KAATYP = :typeAffaire
and KAAIPB = :numeroAffaire
and KAAALX = :version
";
            const string update=@"UPDATE KPENT SET 
KAATYP = :KAATYP, KAAIPB = :KAAIPB, KAAALX = :KAAALX, KAABONI = :KAABONI, KAABONT = :KAABONT, KAAANTI = :KAAANTI, KAADESI = :KAADESI, KAAOBSV = :KAAOBSV, KAALCIVALO = :KAALCIVALO, KAALCIVALA = :KAALCIVALA
, KAALCIVALW = :KAALCIVALW, KAALCIUNIT = :KAALCIUNIT, KAALCIBASE = :KAALCIBASE, KAAKDIID = :KAAKDIID, KAAFRHVALO = :KAAFRHVALO, KAAFRHVALA = :KAAFRHVALA, KAAFRHVALW = :KAAFRHVALW, KAAFRHUNIT = :KAAFRHUNIT, KAAFRHBASE = :KAAFRHBASE, KAAKDKID = :KAAKDKID
, KAAATGLCI = :KAAATGLCI, KAAATGKLC = :KAAATGKLC, KAAATGCAP = :KAAATGCAP, KAAATGKCA = :KAAATGKCA, KAAATGSUR = :KAAATGSUR, KAAATGBCN = :KAAATGBCN, KAAATGKBC = :KAAATGKBC, KAAATGCRI = :KAAATGCRI, KAAATGAPT = :KAAATGAPT, KAAATGF = :KAAATGF
, KAAATGAPR = :KAAATGAPR, KAAATGTRT = :KAAATGTRT, KAAATGTRR = :KAAATGTRR, KAAATGTCT = :KAAATGTCT, KAAATGTCR = :KAAATGTCR, KAAATGTFT = :KAAATGTFT, KAAATGTCM = :KAAATGTCM, KAAATGTFA = :KAAATGTFA, KAAATGCTX = :KAAATGCTX, KAAATGLCF = :KAAATGLCF
, KAAATGCAF = :KAAATGCAF, KAAATGSUF = :KAAATGSUF, KAAATGBCF = :KAAATGBCF, KAALCIINA = :KAALCIINA, KAAATGFRR = :KAAATGFRR, KAAATGCMT = :KAAATGCMT, KAAATGFAT = :KAAATGFAT, KAAATGBAS = :KAAATGBAS, KAAATGKBA = :KAAATGKBA, KAAFRHINA = :KAAFRHINA
, KAAAND = :KAAAND, KAADPRJ = :KAADPRJ, KAADSTA = :KAADSTA, KAAOBSF = :KAAOBSF, KAAOBSA = :KAAOBSA, KAAOBSC = :KAAOBSC, KAAASS = :KAAASS, KAAAFS = :KAAAFS, KAAXCMS = :KAAXCMS, KAACNCS = :KAACNCS
, KAACIBLE = :KAACIBLE, KAAMAXA = :KAAMAXA, KAAMAXE = :KAAMAXE, KAAIDE = :KAAIDE, KAAIMED = :KAAIMED, KAAIMDA = :KAAIMDA, KAAISIN = :KAAISIN, KAAAVH = :KAAAVH, KAAAVDS = :KAAAVDS, KAARCP = :KAARCP
, KAAPAQ = :KAAPAQ, KAALTASP = :KAALTASP, KAASCAT = :KAASCAT, KAARELDT = :KAARELDT, KAAQUACH = :KAAQUACH, KAAQUVEN = :KAAQUVEN, KAAAVAO = :KAAAVAO, KAAARIPK = :KAAARIPK, KAAARTYG = :KAAARTYG, KAAPKRD = :KAAPKRD
, KAASUDD = :KAASUDD, KAASUDH = :KAASUDH, KAASUFD = :KAASUFD, KAASUFH = :KAASUFH, KAARSDD = :KAARSDD, KAARSDH = :KAARSDH, KAAATTDOC = :KAAATTDOC
 WHERE 
KAATYP = :typeAffaire and KAAIPB = :numeroAffaire and KAAALX = :version";
            const string delete=@"DELETE FROM KPENT WHERE KAATYP = :typeAffaire AND KAAIPB = :numeroAffaire AND KAAALX = :version";
            const string insert=@"INSERT INTO  KPENT (
KAATYP, KAAIPB, KAAALX, KAABONI, KAABONT
, KAAANTI, KAADESI, KAAOBSV, KAALCIVALO, KAALCIVALA
, KAALCIVALW, KAALCIUNIT, KAALCIBASE, KAAKDIID, KAAFRHVALO
, KAAFRHVALA, KAAFRHVALW, KAAFRHUNIT, KAAFRHBASE, KAAKDKID
...
, KAASUDD, KAASUDH, KAASUFD, KAASUFH, KAARSDD
, KAARSDH, KAAATTDOC FROM KPENT
WHERE KAAIPB = :parKAAIPB
";
            #endregion

            public KpEntRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public KpEnt Get(string typeAffaire, string numeroAffaire, int version){
                return connection.Query<KpEnt>(select, new {typeAffaire, numeroAffaire, version}).SingleOrDefault();
            }
            ...
            public void Insert(KpEnt value){
                    ...
                    parameters.Add("KAAATTDOC",value.Kaaattdoc??String.Empty, dbType:DbType.AnsiStringFixedLength, direction:ParameterDirection.Input, size:1, scale: 0);

                    connection.EnsureOpened().Execute(insert,parameters);
            }
            public void Delete(KpEnt value){
                    var parameters = new DynamicParameters();
                    parameters.Add("typeAffaire",value.Kaatyp);
                    parameters.Add("numeroAffaire",value.Kaaipb);
                    parameters.Add("version",value.Kaaalx);
            ...
            public IEnumerable<KpEnt> SelectByIpb(string parKAAIPB){
                    return connection.EnsureOpened().Query<KpEnt>(select_SelectByIpb, new {parKAAIPB}).ToList();
            }
    }
}
