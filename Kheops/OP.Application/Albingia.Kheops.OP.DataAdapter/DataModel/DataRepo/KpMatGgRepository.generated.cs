...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  KpMatGgRepository : BaseTableRepository {
...
KEETYP, KEEIPB, KEEALX, KEECHR, KEETYE
, KEEKDCID, KEEVOLET, KEEKAKID, KEEBLOC, KEEKAEID
, KEEGARAN, KEESEQ, KEENIV, KEEVID FROM KPMATGG
WHERE KEETYP = :KEETYP
and KEEIPB = :KEEIPB
and KEEALX = :KEEALX
and KEECHR = :KEECHR
";
            const string update=@"UPDATE KPMATGG SET 
KEETYP = :KEETYP, KEEIPB = :KEEIPB, KEEALX = :KEEALX, KEECHR = :KEECHR, KEETYE = :KEETYE, KEEKDCID = :KEEKDCID, KEEVOLET = :KEEVOLET, KEEKAKID = :KEEKAKID, KEEBLOC = :KEEBLOC, KEEKAEID = :KEEKAEID
, KEEGARAN = :KEEGARAN, KEESEQ = :KEESEQ, KEENIV = :KEENIV, KEEVID = :KEEVID
 WHERE 
KEETYP = :KEETYP and KEEIPB = :KEEIPB and KEEALX = :KEEALX and KEECHR = :KEECHR";
            const string delete=@"DELETE FROM KPMATGG WHERE KEETYP = :KEETYP AND KEEIPB = :KEEIPB AND KEEALX = :KEEALX AND KEECHR = :KEECHR";
            const string insert=@"INSERT INTO  KPMATGG (
KEETYP, KEEIPB, KEEALX, KEECHR, KEETYE
, KEEKDCID, KEEVOLET, KEEKAKID, KEEBLOC, KEEKAEID
, KEEGARAN, KEESEQ, KEENIV, KEEVID
) VALUES (
:KEETYP, :KEEIPB, :KEEALX, :KEECHR, :KEETYE
, :KEEKDCID, :KEEVOLET, :KEEKAKID, :KEEBLOC, :KEEKAEID
, :KEEGARAN, :KEESEQ, :KEENIV, :KEEVID)";
...
";
            ...
            public KpMatGgRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public KpMatGg Get(string KEETYP, string KEEIPB, int KEEALX, int KEECHR){
                return connection.Query<KpMatGg>(select, new {KEETYP, KEEIPB, KEEALX, KEECHR}).SingleOrDefault();
            }
            ...
            public IEnumerable<KpMatGg> GetByAffaire(string KEETYP, string KEEIPB, int KEEALX){
                    return connection.EnsureOpened().Query<KpMatGg>(select_GetByAffaire, new {KEETYP, KEEIPB, KEEALX}).ToList();
            }
    }
}
