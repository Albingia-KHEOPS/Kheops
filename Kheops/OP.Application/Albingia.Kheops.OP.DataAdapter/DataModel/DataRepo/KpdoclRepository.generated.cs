...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  KpDocLRepository : BaseTableRepository {
...
, KELMAJD, KELMAJH, KELEMI, KELIPK FROM KPDOCL
WHERE KELID = :id
";
            const string update=@"UPDATE KPDOCL SET 
...
, KELMAJD = :KELMAJD, KELMAJH = :KELMAJH, KELEMI = :KELEMI, KELIPK = :KELIPK
 WHERE 
KELID = :id";
            const string delete=@"DELETE FROM KPDOCL WHERE KELID = :id";
            const string insert=@"INSERT INTO  KPDOCL (
KELID, KELTYP, KELIPB, KELALX, KELSUA
, KELNUM, KELSBR, KELSERV, KELACTG, KELACTN
, KELAVN, KELLIB, KELSTU, KELSIT, KELSTD
, KELSTH, KELCRU, KELCRD, KELCRH, KELMAJU
...
";
            ...
            public KpDocLRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public KpDocL Get(Int64 id){
                return connection.Query<KpDocL>(select, new {id}).SingleOrDefault();
            }
