...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  YhpbaseRepository : BaseTableRepository {
...
PBIPB, PBALX, PBAVN, PBHIN, PBHIA
, PBHIM, PBHIJ, PBHIH, PBHIU, PBTBR
, PBIAS, PBREF, PBBRA, PBSBR, PBCAT
, PBICT, PBTIL, PBINL, PBOCT, PBAD1
, PBAD2, PBDEP, PBCPO, PBVIL, PBPAY
, PBSAA, PBSAM, PBSAJ, PBSAH, PBAPR
, PBAPP, PBMO1, PBMO2, PBMO3, PBCLE
, PBANT, PBCTD, PBCTU, PBAPO, PBDUR
, PBREL, PBRLD, PBATT, PBRMP, PBVRF
, PBOLV, PBFOA, PBFOM, PBCOU, PBFOE
, PBDEV, PBRGT, PBTCO, PBNAT, PBDST
, PBLIE, PBGES, PBSOU, PBORI, PBMAI
, PBEFA, PBEFM, PBEFJ, PBOFF, PBOFV
, PBIPA, PBALA, PBECM, PBECJ, PBPCV
, PBCTA, PBNRQ, PBNPL, PBPER, PBAVC
...
, PBSTF, PBPIM, PBIN5, PBORK, PBHTY
, PBHNA, PBHDT, PBHZA, PBTYP FROM YHPBASE
WHERE PBTYP = :type
and PBIPB = :numeroAffaire
and PBALX = :numeroAliment
and PBAVN = :numeroAvenant
";
            const string update=@"UPDATE YHPBASE SET 
PBIPB = :PBIPB, PBALX = :PBALX, PBAVN = :PBAVN, PBHIN = :PBHIN, PBHIA = :PBHIA, PBHIM = :PBHIM, PBHIJ = :PBHIJ, PBHIH = :PBHIH, PBHIU = :PBHIU, PBTBR = :PBTBR
, PBIAS = :PBIAS, PBREF = :PBREF, PBBRA = :PBBRA, PBSBR = :PBSBR, PBCAT = :PBCAT, PBICT = :PBICT, PBTIL = :PBTIL, PBINL = :PBINL, PBOCT = :PBOCT, PBAD1 = :PBAD1
, PBAD2 = :PBAD2, PBDEP = :PBDEP, PBCPO = :PBCPO, PBVIL = :PBVIL, PBPAY = :PBPAY, PBSAA = :PBSAA, PBSAM = :PBSAM, PBSAJ = :PBSAJ, PBSAH = :PBSAH, PBAPR = :PBAPR
, PBAPP = :PBAPP, PBMO1 = :PBMO1, PBMO2 = :PBMO2, PBMO3 = :PBMO3, PBCLE = :PBCLE, PBANT = :PBANT, PBCTD = :PBCTD, PBCTU = :PBCTU, PBAPO = :PBAPO, PBDUR = :PBDUR
, PBREL = :PBREL, PBRLD = :PBRLD, PBATT = :PBATT, PBRMP = :PBRMP, PBVRF = :PBVRF, PBOLV = :PBOLV, PBFOA = :PBFOA, PBFOM = :PBFOM, PBCOU = :PBCOU, PBFOE = :PBFOE
, PBDEV = :PBDEV, PBRGT = :PBRGT, PBTCO = :PBTCO, PBNAT = :PBNAT, PBDST = :PBDST, PBLIE = :PBLIE, PBGES = :PBGES, PBSOU = :PBSOU, PBORI = :PBORI, PBMAI = :PBMAI
, PBEFA = :PBEFA, PBEFM = :PBEFM, PBEFJ = :PBEFJ, PBOFF = :PBOFF, PBOFV = :PBOFV, PBIPA = :PBIPA, PBALA = :PBALA, PBECM = :PBECM, PBECJ = :PBECJ, PBPCV = :PBPCV
, PBCTA = :PBCTA, PBNRQ = :PBNRQ, PBNPL = :PBNPL, PBPER = :PBPER, PBAVC = :PBAVC, PBAVA = :PBAVA, PBAVM = :PBAVM, PBAVJ = :PBAVJ, PBRSC = :PBRSC, PBRSA = :PBRSA
, PBRSM = :PBRSM, PBRSJ = :PBRSJ, PBMER = :PBMER, PBETA = :PBETA, PBSIT = :PBSIT, PBSTA = :PBSTA, PBSTM = :PBSTM, PBSTJ = :PBSTJ, PBSTQ = :PBSTQ, PBEDT = :PBEDT
, PBTAC = :PBTAC, PBTAA = :PBTAA, PBTAM = :PBTAM, PBTAJ = :PBTAJ, PBCRU = :PBCRU, PBCRA = :PBCRA, PBCRM = :PBCRM, PBCRJ = :PBCRJ, PBMJU = :PBMJU, PBMJA = :PBMJA
, PBMJM = :PBMJM, PBMJJ = :PBMJJ, PBDEU = :PBDEU, PBDEA = :PBDEA, PBDEM = :PBDEM, PBDEJ = :PBDEJ, PBCTP = :PBCTP, PBEFH = :PBEFH, PBFEA = :PBFEA, PBFEM = :PBFEM
, PBFEJ = :PBFEJ, PBFEH = :PBFEH, PBSTP = :PBSTP, PBNVA = :PBNVA, PBFEC = :PBFEC, PBPOR = :PBPOR, PBCON = :PBCON, PBTTR = :PBTTR, PBAVK = :PBAVK, PBADH = :PBADH
, PBSTF = :PBSTF, PBPIM = :PBPIM, PBIN5 = :PBIN5, PBORK = :PBORK, PBHTY = :PBHTY, PBHNA = :PBHNA, PBHDT = :PBHDT, PBHZA = :PBHZA, PBTYP = :PBTYP
 WHERE 
PBTYP = :type and PBIPB = :numeroAffaire and PBALX = :numeroAliment and PBAVN = :numeroAvenant";
            const string delete=@"DELETE FROM YHPBASE WHERE PBTYP = :type AND PBIPB = :numeroAffaire AND PBALX = :numeroAliment AND PBAVN = :numeroAvenant";
            const string insert=@"INSERT INTO  YHPBASE (
PBIPB, PBALX, PBAVN, PBHIN, PBHIA
, PBHIM, PBHIJ, PBHIH, PBHIU, PBTBR
, PBIAS, PBREF, PBBRA, PBSBR, PBCAT
, PBICT, PBTIL, PBINL, PBOCT, PBAD1
...
, :PBSTF, :PBPIM, :PBIN5, :PBORK, :PBHTY
, :PBHNA, :PBHDT, :PBHZA, :PBTYP)";
            const string select_SelectByIpbAlx=@"SELECT
PBIPB, PBALX, PBAVN, PBHIN, PBHIA
, PBHIM, PBHIJ, PBHIH, PBHIU, PBTBR
, PBIAS, PBREF, PBBRA, PBSBR, PBCAT
, PBICT, PBTIL, PBINL, PBOCT, PBAD1
...
";
            ...
            public YhpbaseRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public YpoBase Get(string type, string numeroAffaire, int numeroAliment, int numeroAvenant){
                return connection.Query<YpoBase>(select, new {type, numeroAffaire, numeroAliment, numeroAvenant}).SingleOrDefault();
            }
            ...
            public void Insert(YpoBase value){
                    ...
                    parameters.Add("PBHIN",value.Pbhin, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
                    parameters.Add("PBHIA",value.Pbhia, dbType:DbType.Int32, direction:ParameterDirection.Input, size:4, scale: 0);
                    parameters.Add("PBHIM",value.Pbhim, dbType:DbType.Int32, direction:ParameterDirection.Input, size:2, scale: 0);
                    parameters.Add("PBHIJ",value.Pbhij, dbType:DbType.Int32, direction:ParameterDirection.Input, size:2, scale: 0);
                    parameters.Add("PBHIH",value.Pbhih, dbType:DbType.Int32, direction:ParameterDirection.Input, size:4, scale: 0);
                    parameters.Add("PBHIU",value.Pbhiu??String.Empty, dbType:DbType.AnsiStringFixedLength, direction:ParameterDirection.Input, size:10, scale: 0);
                    ...
                    parameters.Add("PBHTY",value.Pbhty??String.Empty, dbType:DbType.AnsiStringFixedLength, direction:ParameterDirection.Input, size:3, scale: 0);
                    parameters.Add("PBHNA",value.Pbhna??String.Empty, dbType:DbType.AnsiStringFixedLength, direction:ParameterDirection.Input, size:3, scale: 0);
                    parameters.Add("PBHDT",value.Pbhdt, dbType:DbType.Int32, direction:ParameterDirection.Input, size:8, scale: 0);
                    parameters.Add("PBHZA",value.Pbhza??String.Empty, dbType:DbType.AnsiStringFixedLength, direction:ParameterDirection.Input, size:20, scale: 0);
            ...
            public void Delete(YpoBase value){
                    var parameters = new DynamicParameters();
                    parameters.Add("type",value.Pbtyp);
                    parameters.Add("numeroAffaire",value.Pbipb);
                    parameters.Add("numeroAliment",value.Pbalx);
                    parameters.Add("numeroAvenant",value.Pbavn);
            ...
            public IEnumerable<YpoBase> SelectByIpbAlx(string parPBIPB, int parPBALX){
                    return connection.EnsureOpened().Query<YpoBase>(select_SelectByIpbAlx, new {parPBIPB, parPBALX}).ToList();
            }
    }
}
