...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  YhrtgarRepository : BaseTableRepository {
...
JHIPB, JHALX, JHAVN, JHHIN, JHRSQ
, JHFOR, JHGAP, JHGAR, JHCAR, JHNAT
, JHGAN, JHOBN, JHOB1, JHOB2, JHOB3
, JHOB4, JHOB5, JHGAV, JHRQV, JHFOV
, JHREP, JHTAX, JHLCV, JHLCA, JHLCW
, JHLCU, JHLCE, JHLC1, JHLC2, JHLC3
, JHLC4, JHLC5, JHLOV, JHLOA, JHLOW
, JHLOU, JHLOE, JHASV, JHASA, JHASW
, JHASU, JHASN, JHFHV, JHFHA, JHFHW
, JHFHU, JHFHE, JHPRV, JHPRA, JHPRW
, JHPRU, JHPRP, JHPRE, JHPRF, JHCNA
, JHINA, JHEFA, JHEFM, JHEFJ, JHEFH
, JHFEA, JHFEM, JHFEJ, JHFEH, JHEFD
, JHEFU, JHTMC, JHTFF, JHCMC, JHCHT
, JHCTT, JHAJT, JHDFG, JHIFC, JHCDA
, JHCDM, JHCDJ, JHCFA, JHCFM, JHCFJ
, JHAVE, JHAVF FROM YHRTGAR
WHERE JHIPB = :JHIPB
and JHALX = :JHALX
and JHAVN = :JHAVN
and JHHIN = :JHHIN
...
and JHGAR = :JHGAR
";
            const string update=@"UPDATE YHRTGAR SET 
JHIPB = :JHIPB, JHALX = :JHALX, JHAVN = :JHAVN, JHHIN = :JHHIN, JHRSQ = :JHRSQ, JHFOR = :JHFOR, JHGAP = :JHGAP, JHGAR = :JHGAR, JHCAR = :JHCAR, JHNAT = :JHNAT
, JHGAN = :JHGAN, JHOBN = :JHOBN, JHOB1 = :JHOB1, JHOB2 = :JHOB2, JHOB3 = :JHOB3, JHOB4 = :JHOB4, JHOB5 = :JHOB5, JHGAV = :JHGAV, JHRQV = :JHRQV, JHFOV = :JHFOV
, JHREP = :JHREP, JHTAX = :JHTAX, JHLCV = :JHLCV, JHLCA = :JHLCA, JHLCW = :JHLCW, JHLCU = :JHLCU, JHLCE = :JHLCE, JHLC1 = :JHLC1, JHLC2 = :JHLC2, JHLC3 = :JHLC3
, JHLC4 = :JHLC4, JHLC5 = :JHLC5, JHLOV = :JHLOV, JHLOA = :JHLOA, JHLOW = :JHLOW, JHLOU = :JHLOU, JHLOE = :JHLOE, JHASV = :JHASV, JHASA = :JHASA, JHASW = :JHASW
, JHASU = :JHASU, JHASN = :JHASN, JHFHV = :JHFHV, JHFHA = :JHFHA, JHFHW = :JHFHW, JHFHU = :JHFHU, JHFHE = :JHFHE, JHPRV = :JHPRV, JHPRA = :JHPRA, JHPRW = :JHPRW
, JHPRU = :JHPRU, JHPRP = :JHPRP, JHPRE = :JHPRE, JHPRF = :JHPRF, JHCNA = :JHCNA, JHINA = :JHINA, JHEFA = :JHEFA, JHEFM = :JHEFM, JHEFJ = :JHEFJ, JHEFH = :JHEFH
, JHFEA = :JHFEA, JHFEM = :JHFEM, JHFEJ = :JHFEJ, JHFEH = :JHFEH, JHEFD = :JHEFD, JHEFU = :JHEFU, JHTMC = :JHTMC, JHTFF = :JHTFF, JHCMC = :JHCMC, JHCHT = :JHCHT
, JHCTT = :JHCTT, JHAJT = :JHAJT, JHDFG = :JHDFG, JHIFC = :JHIFC, JHCDA = :JHCDA, JHCDM = :JHCDM, JHCDJ = :JHCDJ, JHCFA = :JHCFA, JHCFM = :JHCFM, JHCFJ = :JHCFJ
, JHAVE = :JHAVE, JHAVF = :JHAVF
 WHERE 
JHIPB = :JHIPB and JHALX = :JHALX and JHAVN = :JHAVN and JHHIN = :JHHIN and JHRSQ = :JHRSQ and JHFOR = :JHFOR and JHGAR = :JHGAR";
            const string delete=@"DELETE FROM YHRTGAR WHERE JHIPB = :JHIPB AND JHALX = :JHALX AND JHAVN = :JHAVN AND JHHIN = :JHHIN AND JHRSQ = :JHRSQ AND JHFOR = :JHFOR AND JHGAR = :JHGAR";
            const string insert=@"INSERT INTO  YHRTGAR (
JHIPB, JHALX, JHAVN, JHHIN, JHRSQ
, JHFOR, JHGAP, JHGAR, JHCAR, JHNAT
, JHGAN, JHOBN, JHOB1, JHOB2, JHOB3
, JHOB4, JHOB5, JHGAV, JHRQV, JHFOV
...
";
            ...
            public YhrtgarRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public YprtGar Get(string JHIPB, int JHALX, int JHAVN, int JHHIN, int JHRSQ, int JHFOR, string JHGAR){
                return connection.Query<YprtGar>(select, new {JHIPB, JHALX, JHAVN, JHHIN, JHRSQ, JHFOR, JHGAR}).SingleOrDefault();
            }
            ...
            public void Insert(YprtGar value){
                    ...
                    parameters.Add("JHAVN",value.Jhavn, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
            ...
            public void Delete(YprtGar value){
                    ...
                    parameters.Add("JHAVN",value.Jhavn);
            ...
            public IEnumerable<YprtGar> GetByAffaire(string JHIPB, int JHALX, int JHAVN){
                    return connection.EnsureOpened().Query<YprtGar>(select_GetByAffaire, new {JHIPB, JHALX, JHAVN}).ToList();
            }
    }
}
