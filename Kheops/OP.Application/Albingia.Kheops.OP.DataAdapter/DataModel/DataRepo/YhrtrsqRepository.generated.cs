...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  YhrtrsqRepository : BaseTableRepository {
...
JEIPB, JEALX, JEAVN, JEHIN, JERSQ
, JECCH, JEMGD, JEBRA, JESBR, JECAT
, JERCS, JECCS, JEVAL, JEVAA, JEVAW
, JEVAT, JEVAU, JEVAH, JETEM, JEVGD
, JEVGU, JEVDA, JEVDM, JEVDJ, JEVDH
, JEVFA, JEVFM, JEVFJ, JEVFH, JEOBJ
, JEROJ, JERGT, JETRR, JECNA, JEINA
, JEIND, JEIXC, JEIXF, JEIXL, JEIXP
, JEGAU, JEGVL, JEGUN, JEPBN, JEPBS
, JEPBR, JEPBT, JEPBC, JEPBP, JEPBA
, JECLV, JEAGM, JEIPM, JEIVX, JEDRO
, JENBO, JELCV, JELCA, JELCW, JELCU
, JELCE, JEAVE, JEAVA, JEAVM, JEAVJ
, JERUL, JERUT, JEAVF, JEEXT FROM YHRTRSQ
WHERE JEIPB = :numeroAffaire
and JEALX = :numeroAliment
and JEAVN = :numeroAvenant
and JERSQ = :numeroRisque
";
            const string update=@"UPDATE YHRTRSQ SET 
JEIPB = :JEIPB, JEALX = :JEALX, JEAVN = :JEAVN, JEHIN = :JEHIN, JERSQ = :JERSQ, JECCH = :JECCH, JEMGD = :JEMGD, JEBRA = :JEBRA, JESBR = :JESBR, JECAT = :JECAT
, JERCS = :JERCS, JECCS = :JECCS, JEVAL = :JEVAL, JEVAA = :JEVAA, JEVAW = :JEVAW, JEVAT = :JEVAT, JEVAU = :JEVAU, JEVAH = :JEVAH, JETEM = :JETEM, JEVGD = :JEVGD
, JEVGU = :JEVGU, JEVDA = :JEVDA, JEVDM = :JEVDM, JEVDJ = :JEVDJ, JEVDH = :JEVDH, JEVFA = :JEVFA, JEVFM = :JEVFM, JEVFJ = :JEVFJ, JEVFH = :JEVFH, JEOBJ = :JEOBJ
, JEROJ = :JEROJ, JERGT = :JERGT, JETRR = :JETRR, JECNA = :JECNA, JEINA = :JEINA, JEIND = :JEIND, JEIXC = :JEIXC, JEIXF = :JEIXF, JEIXL = :JEIXL, JEIXP = :JEIXP
, JEGAU = :JEGAU, JEGVL = :JEGVL, JEGUN = :JEGUN, JEPBN = :JEPBN, JEPBS = :JEPBS, JEPBR = :JEPBR, JEPBT = :JEPBT, JEPBC = :JEPBC, JEPBP = :JEPBP, JEPBA = :JEPBA
, JECLV = :JECLV, JEAGM = :JEAGM, JEIPM = :JEIPM, JEIVX = :JEIVX, JEDRO = :JEDRO, JENBO = :JENBO, JELCV = :JELCV, JELCA = :JELCA, JELCW = :JELCW, JELCU = :JELCU
, JELCE = :JELCE, JEAVE = :JEAVE, JEAVA = :JEAVA, JEAVM = :JEAVM, JEAVJ = :JEAVJ, JERUL = :JERUL, JERUT = :JERUT, JEAVF = :JEAVF, JEEXT = :JEEXT
 WHERE 
JEIPB = :numeroAffaire and JEALX = :numeroAliment and JEAVN = :numeroAvenant and JERSQ = :numeroRisque";
            const string delete=@"DELETE FROM YHRTRSQ WHERE JEIPB = :numeroAffaire AND JEALX = :numeroAliment AND JEAVN = :numeroAvenant AND JERSQ = :numeroRisque";
            const string insert=@"INSERT INTO  YHRTRSQ (
JEIPB, JEALX, JEAVN, JEHIN, JERSQ
, JECCH, JEMGD, JEBRA, JESBR, JECAT
, JERCS, JECCS, JEVAL, JEVAA, JEVAW
, JEVAT, JEVAU, JEVAH, JETEM, JEVGD
...
, JELCE, JEAVE, JEAVA, JEAVM, JEAVJ
, JERUL, JERUT, JEAVF, JEEXT FROM YHRTRSQ
WHERE JEIPB = :parJEIPB
and JEALX = :parJEALX
";
            #endregion

            public YhrtrsqRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public YprtRsq Get(string numeroAffaire, int numeroAliment, int numeroAvenant, int numeroRisque){
                return connection.Query<YprtRsq>(select, new {numeroAffaire, numeroAliment, numeroAvenant, numeroRisque}).SingleOrDefault();
            }
            ...
            public void Insert(YprtRsq value){
                    ...
                    parameters.Add("JEAVN",value.Jeavn, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
                    parameters.Add("JEHIN",value.Jehin, dbType:DbType.Int32, direction:ParameterDirection.Input, size:3, scale: 0);
            ...
            public void Delete(YprtRsq value){
                    ...
                    parameters.Add("numeroAliment",value.Jealx);
                    parameters.Add("numeroAvenant",value.Jeavn);
                    parameters.Add("numeroRisque",value.Jersq);
            ...
            public IEnumerable<YprtRsq> GetByAffaire(string code, int version, int numeroAvenant, int versionHisto){
                    return connection.EnsureOpened().Query<YprtRsq>(select_GetByAffaire, new {code, version, numeroAvenant, versionHisto}).ToList();
            }
            public IEnumerable<YprtRsq> GetAllByIpbAlx(string parJEIPB, int parJEALX){
                    return connection.EnsureOpened().Query<YprtRsq>(select_GetAllByIpbAlx, new {parJEIPB, parJEALX}).ToList();
            }
    }
}
