...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  YprtEntRepository : BaseTableRepository {
...
JDIPB, JDALX, JDSHT, JDENC, JDITC
, JDVAL, JDVAA, JDVAW, JDVAT, JDVAU
, JDVAH, JDDRQ, JDNBR, JDTXL, JDTRR
, JDXCM, JDNEX, JDNPA, JDAFC, JDAFR
, JDATT, JDCNA, JDCNC, JDINA, JDIND
, JDIXC, JDIXF, JDIXL, JDIXP, JDIVO
, JDIVA, JDIVW, JDMHT, JDREA, JDREB
, JDREH, JDDPV, JDGAU, JDGVL, JDGUN
, JDPBN, JDPBS, JDPBR, JDPBT, JDPBC
, JDPBP, JDPBA, JDRCG, JDCCG, JDRCS
, JDCCS, JDCLV, JDAGM, JDLCV, JDLCA
, JDLCW, JDLCU, JDLCE, JDDPA, JDDPM
, JDDPJ, JDFPA, JDFPM, JDFPJ, JDPEA
, JDPEM, JDPEJ, JDACQ, JDTMC, JDTFO
, JDTFT, JDTFF, JDTFP, JDPRO, JDTMI
, JDTFM, JDTMA, JDTMG, JDCMC, JDCFO
, JDCFT, JDCFH, JDCHT, JDCTT, JDCCP
, JDEHH, JDEHC, JDSMP, JDIVX, JDTCR
, JDNPG, JDEDI, JDEDN, JDEDA, JDEDM
, JDEDJ, JDEHI, JDIAX, JDTED, JDDOO
, JDRUA, JDRUM, JDRUJ, JDECG, JDECP
, JDAPT, JDAPR, JDAAT, JDAAR, JDACR
, JDACV, JDAXT, JDAXC, JDAXF, JDAXM
, JDAXG, JDATA, JDATX, JDAUT, JDAUF
, JDLTA, JDLTASP, JDLDEB, JDLDEH, JDLFIN
, JDLFIH, JDLDUR, JDLDUU FROM YPRTENT
WHERE JDIPB = :numeroAffaire
and JDALX = :version
";
            const string update=@"UPDATE YPRTENT SET 
JDIPB = :JDIPB, JDALX = :JDALX, JDSHT = :JDSHT, JDENC = :JDENC, JDITC = :JDITC, JDVAL = :JDVAL, JDVAA = :JDVAA, JDVAW = :JDVAW, JDVAT = :JDVAT, JDVAU = :JDVAU
, JDVAH = :JDVAH, JDDRQ = :JDDRQ, JDNBR = :JDNBR, JDTXL = :JDTXL, JDTRR = :JDTRR, JDXCM = :JDXCM, JDNEX = :JDNEX, JDNPA = :JDNPA, JDAFC = :JDAFC, JDAFR = :JDAFR
, JDATT = :JDATT, JDCNA = :JDCNA, JDCNC = :JDCNC, JDINA = :JDINA, JDIND = :JDIND, JDIXC = :JDIXC, JDIXF = :JDIXF, JDIXL = :JDIXL, JDIXP = :JDIXP, JDIVO = :JDIVO
, JDIVA = :JDIVA, JDIVW = :JDIVW, JDMHT = :JDMHT, JDREA = :JDREA, JDREB = :JDREB, JDREH = :JDREH, JDDPV = :JDDPV, JDGAU = :JDGAU, JDGVL = :JDGVL, JDGUN = :JDGUN
, JDPBN = :JDPBN, JDPBS = :JDPBS, JDPBR = :JDPBR, JDPBT = :JDPBT, JDPBC = :JDPBC, JDPBP = :JDPBP, JDPBA = :JDPBA, JDRCG = :JDRCG, JDCCG = :JDCCG, JDRCS = :JDRCS
, JDCCS = :JDCCS, JDCLV = :JDCLV, JDAGM = :JDAGM, JDLCV = :JDLCV, JDLCA = :JDLCA, JDLCW = :JDLCW, JDLCU = :JDLCU, JDLCE = :JDLCE, JDDPA = :JDDPA, JDDPM = :JDDPM
, JDDPJ = :JDDPJ, JDFPA = :JDFPA, JDFPM = :JDFPM, JDFPJ = :JDFPJ, JDPEA = :JDPEA, JDPEM = :JDPEM, JDPEJ = :JDPEJ, JDACQ = :JDACQ, JDTMC = :JDTMC, JDTFO = :JDTFO
, JDTFT = :JDTFT, JDTFF = :JDTFF, JDTFP = :JDTFP, JDPRO = :JDPRO, JDTMI = :JDTMI, JDTFM = :JDTFM, JDTMA = :JDTMA, JDTMG = :JDTMG, JDCMC = :JDCMC, JDCFO = :JDCFO
, JDCFT = :JDCFT, JDCFH = :JDCFH, JDCHT = :JDCHT, JDCTT = :JDCTT, JDCCP = :JDCCP, JDEHH = :JDEHH, JDEHC = :JDEHC, JDSMP = :JDSMP, JDIVX = :JDIVX, JDTCR = :JDTCR
, JDNPG = :JDNPG, JDEDI = :JDEDI, JDEDN = :JDEDN, JDEDA = :JDEDA, JDEDM = :JDEDM, JDEDJ = :JDEDJ, JDEHI = :JDEHI, JDIAX = :JDIAX, JDTED = :JDTED, JDDOO = :JDDOO
, JDRUA = :JDRUA, JDRUM = :JDRUM, JDRUJ = :JDRUJ, JDECG = :JDECG, JDECP = :JDECP, JDAPT = :JDAPT, JDAPR = :JDAPR, JDAAT = :JDAAT, JDAAR = :JDAAR, JDACR = :JDACR
, JDACV = :JDACV, JDAXT = :JDAXT, JDAXC = :JDAXC, JDAXF = :JDAXF, JDAXM = :JDAXM, JDAXG = :JDAXG, JDATA = :JDATA, JDATX = :JDATX, JDAUT = :JDAUT, JDAUF = :JDAUF
, JDLTA = :JDLTA, JDLTASP = :JDLTASP, JDLDEB = :JDLDEB, JDLDEH = :JDLDEH, JDLFIN = :JDLFIN, JDLFIH = :JDLFIH, JDLDUR = :JDLDUR, JDLDUU = :JDLDUU
 WHERE 
JDIPB = :numeroAffaire and JDALX = :version";
            const string delete=@"DELETE FROM YPRTENT WHERE JDIPB = :numeroAffaire AND JDALX = :version";
            const string insert=@"INSERT INTO  YPRTENT (
JDIPB, JDALX, JDSHT, JDENC, JDITC
, JDVAL, JDVAA, JDVAW, JDVAT, JDVAU
, JDVAH, JDDRQ, JDNBR, JDTXL, JDTRR
, JDXCM, JDNEX, JDNPA, JDAFC, JDAFR
...
, JDLTA, JDLTASP, JDLDEB, JDLDEH, JDLFIN
, JDLFIH, JDLDUR, JDLDUU FROM YPRTENT
WHERE JDIPB = :parJDIPB
";
            #endregion

            public YprtEntRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public YprtEnt Get(string numeroAffaire, int version){
                return connection.Query<YprtEnt>(select, new {numeroAffaire, version}).SingleOrDefault();
            }
            ...
            public void Delete(YprtEnt value){
                    ...
                    parameters.Add("version",value.Jdalx);
            ...
            public IEnumerable<YprtEnt> SelectByIpb(string parJDIPB){
                    return connection.EnsureOpened().Query<YprtEnt>(select_SelectByIpb, new {parJDIPB}).ToList();
            }
    }
}
