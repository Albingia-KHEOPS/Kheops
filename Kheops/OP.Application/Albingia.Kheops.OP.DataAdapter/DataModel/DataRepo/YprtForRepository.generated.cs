...
namespace Albingia.Kheops.OP.DataAdapter.DataModel.Repository {
    ...
    public  partial class  YprtForRepository : BaseTableRepository {
...
JOIPB, JOALX, JORSQ, JOFOR, JODES
, JOCCH, JOFRV, JOFSP, JORLE, JOACQ
, JOTMC, JOTFF, JOTFP, JOPRO, JOTMI
, JOTFM, JOTMA, JOTMG, JOCMC, JOCFO
, JOCHT, JOCTT, JOCCP, JOCPA, JOVAL
, JOVAA, JOVAW, JOVAT, JOVAU, JOVAH
, JOIVO, JOIVA, JOIVW, JOAVE, JOAVA
, JOAVM, JOAVJ, JOPAQ, JOEHH, JOEHC
, JOEHI, JOCOS, JOTQU FROM YPRTFOR
WHERE JOIPB = :JOIPB
and JOALX = :JOALX
and JORSQ = :JORSQ
and JOFOR = :JOFOR
";
            const string update=@"UPDATE YPRTFOR SET 
JOIPB = :JOIPB, JOALX = :JOALX, JORSQ = :JORSQ, JOFOR = :JOFOR, JODES = :JODES, JOCCH = :JOCCH, JOFRV = :JOFRV, JOFSP = :JOFSP, JORLE = :JORLE, JOACQ = :JOACQ
, JOTMC = :JOTMC, JOTFF = :JOTFF, JOTFP = :JOTFP, JOPRO = :JOPRO, JOTMI = :JOTMI, JOTFM = :JOTFM, JOTMA = :JOTMA, JOTMG = :JOTMG, JOCMC = :JOCMC, JOCFO = :JOCFO
, JOCHT = :JOCHT, JOCTT = :JOCTT, JOCCP = :JOCCP, JOCPA = :JOCPA, JOVAL = :JOVAL, JOVAA = :JOVAA, JOVAW = :JOVAW, JOVAT = :JOVAT, JOVAU = :JOVAU, JOVAH = :JOVAH
, JOIVO = :JOIVO, JOIVA = :JOIVA, JOIVW = :JOIVW, JOAVE = :JOAVE, JOAVA = :JOAVA, JOAVM = :JOAVM, JOAVJ = :JOAVJ, JOPAQ = :JOPAQ, JOEHH = :JOEHH, JOEHC = :JOEHC
, JOEHI = :JOEHI, JOCOS = :JOCOS, JOTQU = :JOTQU
 WHERE 
JOIPB = :JOIPB and JOALX = :JOALX and JORSQ = :JORSQ and JOFOR = :JOFOR";
            const string delete=@"DELETE FROM YPRTFOR WHERE JOIPB = :JOIPB AND JOALX = :JOALX AND JORSQ = :JORSQ AND JOFOR = :JOFOR";
            const string insert=@"INSERT INTO  YPRTFOR (
JOIPB, JOALX, JORSQ, JOFOR, JODES
, JOCCH, JOFRV, JOFSP, JORLE, JOACQ
, JOTMC, JOTFF, JOTFP, JOPRO, JOTMI
, JOTFM, JOTMA, JOTMG, JOCMC, JOCFO
...
";
            ...
            public YprtForRepository (IDbConnection connection, IdentifierGenerator idGenerator) : base (connection) {
                this.idGenerator = idGenerator;
            }
 
            public YprtFor Get(string JOIPB, int JOALX, int JORSQ, int JOFOR){
                return connection.Query<YprtFor>(select, new {JOIPB, JOALX, JORSQ, JOFOR}).SingleOrDefault();
            }
            ...
            public IEnumerable<YprtFor> GetByAffaire(string JOIPB, int JOALX){
                    return connection.EnsureOpened().Query<YprtFor>(select_GetByAffaire, new {JOIPB, JOALX}).ToList();
            }
    }
}
