...
{
    [DataContract]
    public class ClauseDto : _Clause_Base
    {
        [DataMember]
        [Column(Name = "ID")]
        ...
        [Column(Name = "DATEDETAILAVNCREATION")]
        public Int64 ColumnDateDetailAvnCreation { get; set; }
        [DataMember]
        ...
        [Column(Name = "DATEAVENANTMODIFICATION")]
        ...
        [Column(Name="ISMODIFSTR")]
        public string IsModifStr { get; set; }
        ...
        [Column(Name = "DOCAJOUTE")]
        public string DocAjoute { get; set; }
        [Column(Name = "DOCLIB")]
        public string DocLib { get; set; }

        [DataMember]
        [Column(Name = "CODESITUATIONHISTO")]
        public string CodeSituationHisto { get; set; }

        [DataMember]
        [Column(Name = "NUMAVENANTHISTO")]
        public Int32 NumeroAvenantHisto { get; set; }
