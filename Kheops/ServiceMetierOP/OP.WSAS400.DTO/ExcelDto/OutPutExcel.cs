...
namespace OP.WSAS400.DTO.ExcelDto
{
 // [DataContract]
  public class OutPutExcel
  {
    ...
    public double ValeurPrmeAnnul { get; set; }
    ...
    public double MinimumPrimeAnnul { get; set; }
    ...
    public double ValeurPrimeIndispo { get; set; }
    ...
    public double MinimumPrimeIndispo { get; set; }
    ...
    public double ValeurPrimeItemperie { get; set; }
    ...
    public double MinimumPrimeItemperie { get; set; }
    ...
    public double ValeurPrimeAttentat { get; set; }
    ...
    public double MinimumPrimeAttentat { get; set; }
